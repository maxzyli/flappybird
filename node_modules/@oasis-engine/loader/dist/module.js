import { resourceLoader, AssetType, AssetPromise, Loader, VertexElement, IndexFormat, VertexElementFormat, AnimationClip, AnimationCurve, InterpolableKeyframe, InterpolationType, SkinnedMeshRenderer, Transform, Entity, PBRMaterial, RenderFace, BlendShape, ModelMesh, BlinnPhongMaterial, Camera, MeshRenderer, Animator, AnimatorController, AnimatorControllerLayer, AnimatorStateMachine, Skin, TextureWrapMode as TextureWrapMode$1, Texture2D, Logger, EngineObject, TextureFormat, TextureCubeMap, TextureCubeFace, SpriteAtlas, Sprite, DirectLight, PointLight, SpotLight, PBRSpecularMaterial, UnlitMaterial, Component, PrimitiveMesh, AnimatorStateTransition, GLCapabilityType, Texture, SkyBoxMaterial, ObjectValues, EventDispatcher } from '@oasis-engine/core';
import { Vector2, Vector3, Vector4, Quaternion, Color, Matrix, Rect, SphericalHarmonics3 } from '@oasis-engine/math';
...
(_dec$j = resourceLoader(AssetType.Buffer, ["bin", "r3bin"], false), _dec$j(_class$j = /*#__PURE__*/function (_Loader) {
...
var _dec$i, _class$i;
(_dec$i = resourceLoader(AssetType.Prefab, ["gltf", "glb"]), _dec$i(_class$i = /*#__PURE__*/function (_Loader) {
...
var _dec$h, _class$h;
(_dec$h = resourceLoader(AssetType.JSON, ["json"], false), _dec$h(_class$h = /*#__PURE__*/function (_Loader) {
...
var _dec$g, _class$g;
(_dec$g = resourceLoader(AssetType.KTXCube, []), _dec$g(_class$g = /*#__PURE__*/function (_Loader) {
...
var _dec$f, _class$f;
(_dec$f = resourceLoader(AssetType.KTX, ["ktx"]), _dec$f(_class$f = /*#__PURE__*/function (_Loader) {
...
var _dec$e, _class$e;
(_dec$e = resourceLoader(AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$e(_class$e = /*#__PURE__*/function (_Loader) {
...
var _dec$d, _class$d;
(_dec$d = resourceLoader(AssetType.TextureCube, [""]), _dec$d(_class$d = /*#__PURE__*/function (_Loader) {
...
var _dec$c, _class$c;
(_dec$c = resourceLoader(AssetType.SpriteAtlas, ["atlas"], false), _dec$c(_class$c = /*#__PURE__*/function (_Loader) {
...
export { GLTFModel, GLTFResource$1 as GLTFResource, Model, Oasis, Parser, SchemaResource, SpritePivotType, parseSingleKTX, parser, registerResource, script };
