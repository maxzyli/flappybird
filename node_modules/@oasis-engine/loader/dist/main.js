...
(_dec$j = core.resourceLoader(core.AssetType.Buffer, ["bin", "r3bin"], false), _dec$j(_class$j = /*#__PURE__*/function (_Loader) {
...
var GLTFUtil = /*#__PURE__*/function () {
  ...
  GLTFUtil.floatBufferToVector2Array = function floatBufferToVector2Array(buffer) {
    ...
    for (var i = 0; i < bufferLen; i += 2) {
      array[i / 2] = new math.Vector2(buffer[i], buffer[i + 1]);
    }
  ...
  GLTFUtil.floatBufferToVector3Array = function floatBufferToVector3Array(buffer) {
    ...
    for (var i = 0; i < bufferLen; i += 3) {
      array[i / 3] = new math.Vector3(buffer[i], buffer[i + 1], buffer[i + 2]);
    }
  ...
  GLTFUtil.floatBufferToVector4Array = function floatBufferToVector4Array(buffer) {
    ...
    for (var i = 0; i < bufferLen; i += 4) {
      array[i / 4] = new math.Vector4(buffer[i], buffer[i + 1], buffer[i + 2], buffer[i + 3]);
    }
  ...
  GLTFUtil.createVertexElement = function createVertexElement(semantic, accessor, index) {
    var size = GLTFUtil.getAccessorTypeSize(accessor.type);
    return new core.VertexElement(semantic, 0, GLTFUtil.getElementFormat(accessor.componentType, size, accessor.normalized), index);
  };
  ...
  GLTFUtil.getElementFormat = function getElementFormat(type, size, normalized) {
    ...
    if (type == AccessorComponentType.SHORT) {
      switch (size) {
        case 2:
          return normalized ? core.VertexElementFormat.NormalizedShort2 : core.VertexElementFormat.Short2;

        case 3:
        case 4:
          return normalized ? core.VertexElementFormat.NormalizedShort4 : core.VertexElementFormat.Short4;
      }
    }
    ...
    if (type == AccessorComponentType.UNSIGNED_SHORT) {
      switch (size) {
        case 2:
          return normalized ? core.VertexElementFormat.NormalizedUShort2 : core.VertexElementFormat.UShort2;

        case 3:
        case 4:
          return normalized ? core.VertexElementFormat.NormalizedUShort4 : core.VertexElementFormat.UShort4;
      }
    }
    ...
    if (type == AccessorComponentType.BYTE) {
      switch (size) {
        ...
        case 3:
        case 4:
          return normalized ? core.VertexElementFormat.NormalizedByte4 : core.VertexElementFormat.Byte4;
      }
    }
    ...
    if (type == AccessorComponentType.UNSIGNED_BYTE) {
      switch (size) {
        ...
        case 3:
        case 4:
          return normalized ? core.VertexElementFormat.NormalizedUByte4 : core.VertexElementFormat.UByte4;
      }
    }
  }
  /**
...
var AnimationParser = /*#__PURE__*/function (_Parser) {
  ...
  _proto.parse = function parse(context) {
    ...
    for (var i = 0; i < animationClipCount; i++) {
      ...
      var animationClip = new core.AnimationClip(name);
      ...
      for (var _i = 0; _i < samplers.length; _i++) {
        ...
        switch (interpolation) {
          case AnimationSamplerInterpolation.CubicSpine:
            samplerInterpolation = core.InterpolationType.CubicSpine;
            break;
          ...
          case AnimationSamplerInterpolation.Linear:
            samplerInterpolation = core.InterpolationType.Linear;
            break;
        }
      ...
      for (var _i2 = 0; _i2 < channels.length; _i2++) {
        ...
        switch (target.path) {
          ...
          case AnimationChannelTargetPath.WEIGHTS:
            compType = core.SkinnedMeshRenderer;
  ...
  _proto._addCurve = function _addCurve(gltfChannel, sampleDataCollection) {
    var curve = new core.AnimationCurve();
    ...
    for (var j = 0, n = input.length; j < n; j++) {
      ...
      if (type === AccessorType.SCALAR) {
        var keyframe = outputSize > 1 ? new core.InterpolableKeyframe() : new core.InterpolableKeyframe();
      ...
      if (type === AccessorType.VEC2) {
        var _keyframe = new core.InterpolableKeyframe();

        _keyframe.time = input[j];
        _keyframe.value = new math.Vector2(output[offset], output[offset + 1]);
        _keyframe.inTangent = new math.Vector2();
        _keyframe.outTangent = new math.Vector2();
        curve.addKey(_keyframe);
      }

      if (type === AccessorType.VEC3) {
        var _keyframe2 = new core.InterpolableKeyframe();

        _keyframe2.time = input[j];
        _keyframe2.value = new math.Vector3(output[offset], output[offset + 1], output[offset + 2]);
        _keyframe2.inTangent = new math.Vector3();
        _keyframe2.outTangent = new math.Vector3();
        curve.addKey(_keyframe2);
      }

      if (type === AccessorType.VEC4) {
        var _keyframe3 = new core.InterpolableKeyframe();

        _keyframe3.time = input[j];
        _keyframe3.value = new math.Quaternion(output[offset], output[offset + 1], output[offset + 2], output[offset + 3]);
        _keyframe3.inTangent = new math.Vector4();
        _keyframe3.outTangent = new math.Vector4();
...
var EntityParser = /*#__PURE__*/function (_Parser) {
  ...
  _proto.parse = function parse(context) {
    ...
    for (var i = 0; i < nodes.length; i++) {
      ...
      var entity = new core.Entity(engine, gltfNode.name || "" + EntityParser._defaultName + i);
  ...
  _proto._createSceneRoots = function _createSceneRoots(context) {
    ...
    for (var i = 0; i < scenes.length; i++) {
      ...
      if (nodes.length === 1) {
        ...
        var rootEntity = new core.Entity(engine, "GLTF_ROOT");
  ...
  _proto.parse = function parse(context) {
    ...
    for (var i = 0; i < gltf.materials.length; i++) {
      ...
      if (!KHR_materials_unlit) {
        ...
        if (emissiveFactor) {
          _m.emissiveColor = _construct(math.Color, emissiveFactor);
        }
      ...
      if (doubleSided) {
        material.renderFace = core.RenderFace.Double;
      } else {
        material.renderFace = core.RenderFace.Front;
      }
...
var MeshParser = /*#__PURE__*/function (_Parser) {
    ...
    var _loop = function _loop(i) {
      ...
      var _loop2 = function _loop2(j) {
        ...
        primitivePromises.push(new Promise(function (resolve) {
          var mesh = new core.ModelMesh(engine, gltfMesh.name || j + "");
  ...
  _proto._createBlendShape = function _createBlendShape(mesh, glTFMesh, glTFTargets, getBlendShapeData) {
    ...
    for (var i = 0, n = glTFTargets.length; i < n; i++) {
      ...
      var blendShape = new core.BlendShape(_name);
...
MeshParser._tempVector3 = new math.Vector3();
...
var SceneParser = /*#__PURE__*/function (_Parser) {
  ...
  SceneParser._getDefaultMaterial = function _getDefaultMaterial(engine) {
    if (!SceneParser._defaultMaterial) {
      SceneParser._defaultMaterial = new core.BlinnPhongMaterial(engine);
    }
  ...
  _proto._createRenderer = function _createRenderer(context, gltfNode, entity) {
    ...
    for (var i = 0; i < gltfMeshPrimitives.length; i++) {
      ...
      if (skinID !== undefined || blendShapeWeights) {
        var skinRenderer = entity.addComponent(core.SkinnedMeshRenderer);
        ...
        renderer = entity.addComponent(core.MeshRenderer);
        renderer.mesh = mesh;
      }
  ...
  _proto._createAnimator = function _createAnimator(context) {
    ...
    var animator = defaultSceneRoot.addComponent(core.Animator);
    var animatorController = new core.AnimatorController();
    var layer = new core.AnimatorControllerLayer("layer");
    var animatorStateMachine = new core.AnimatorStateMachine();
  ...
  _proto.parse = function parse(context) {
    ...
    for (var i = 0; i < gltfSkins.length; i++) {
      ...
      for (var _i = 0; _i < jointCount; _i++) {
        var inverseBindMatrix = new math.Matrix();
...
var TextureParser = /*#__PURE__*/function (_Parser) {
      ...
      return Promise.all(gltf.textures.map(function (_ref, index) {
        ...
        if (uri) {
          ...
          return GLTFUtil.loadImageBuffer(bufferViewData, mimeType).then(function (image) {
            var texture = new core.Texture2D(engine, image.width, image.height);
  ...
  _proto._parseSampler = function _parseSampler(texture, sampler) {
    ...
    if (magFilter || minFilter) {
      core.Logger.warn("texture use filterMode in engine");
    }
...
TextureParser._wrapMap = {
  33071: core.TextureWrapMode.Clamp,
  33648: core.TextureWrapMode.Mirror,
  10497: core.TextureWrapMode.Repeat
};
    ...
    if (extensionsUsed) {
      ...
      for (var i = 0; i < extensionsUsed.length; i++) {
        if (!Parser$1.hasExtensionParser(extensionsUsed[i])) {
          core.Logger.warn("Extension " + extensionsUsed[i] + " is not implemented, you can customize this extension in gltf.");
        }
      }
    }
    ...
    if (extensionsRequired) {
      ...
      for (var _i = 0; _i < extensionsRequired.length; _i++) {
        ...
        if (!Parser$1.hasExtensionParser(extensionRequired)) {
          core.Logger.error("GLTF parser has not supported required extension " + extensionRequired + ".");
        } else {
...
var _dec$i, _class$i;
(_dec$i = core.resourceLoader(core.AssetType.Prefab, ["gltf", "glb"]), _dec$i(_class$i = /*#__PURE__*/function (_Loader) {
  ...
  return GLTFLoader;
}(core.Loader)) || _class$i);

var _dec$h, _class$h;
(_dec$h = core.resourceLoader(core.AssetType.JSON, ["json"], false), _dec$h(_class$h = /*#__PURE__*/function (_Loader) {
...
function getEngineFormat(internalFormat) {
  switch (internalFormat) {
    ...
    // break;
    case rhiWebgl.GLCompressedTextureInternalFormat.RGB_S3TC_DXT1_EXT:
      return core.TextureFormat.DXT1;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_S3TC_DXT5_EXT:
      return core.TextureFormat.DXT5;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGB_ETC1_WEBGL:
      return core.TextureFormat.ETC1_RGB;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGB8_ETC2:
      return core.TextureFormat.ETC2_RGB;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGB8_PUNCHTHROUGH_ALPHA1_ETC2:
      return core.TextureFormat.ETC2_RGBA5;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA8_ETC2_EAC:
      return core.TextureFormat.ETC2_RGBA8;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGB_PVRTC_2BPPV1_IMG:
      return core.TextureFormat.PVRTC_RGB2;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_PVRTC_2BPPV1_IMG:
      return core.TextureFormat.PVRTC_RGBA2;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGB_PVRTC_4BPPV1_IMG:
      return core.TextureFormat.PVRTC_RGB4;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_PVRTC_4BPPV1_IMG:
      return core.TextureFormat.PVRTC_RGBA4;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_ASTC_4X4_KHR:
      return core.TextureFormat.ASTC_4x4;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_ASTC_5X5_KHR:
      return core.TextureFormat.ASTC_5x5;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_ASTC_6X6_KHR:
      return core.TextureFormat.ASTC_6x6;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_ASTC_8X8_KHR:
      return core.TextureFormat.ASTC_8x8;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_ASTC_10X10_KHR:
      return core.TextureFormat.ASTC_10x10;

    case rhiWebgl.GLCompressedTextureInternalFormat.RGBA_ASTC_12X12_KHR:
      return core.TextureFormat.ASTC_12x12;

    default:
      var formatName = rhiWebgl.GLCompressedTextureInternalFormat[internalFormat];
...
var _dec$g, _class$g;
(_dec$g = core.resourceLoader(core.AssetType.KTXCube, []), _dec$g(_class$g = /*#__PURE__*/function (_Loader) {
...
}(core.Loader)) || _class$g);

var _dec$f, _class$f;
(_dec$f = core.resourceLoader(core.AssetType.KTX, ["ktx"]), _dec$f(_class$f = /*#__PURE__*/function (_Loader) {
  ...
  return KTXLoader;
}(core.Loader)) || _class$f);

var _dec$e, _class$e;
(_dec$e = core.resourceLoader(core.AssetType.Texture2D, ["png", "jpg", "webp", "jpeg"]), _dec$e(_class$e = /*#__PURE__*/function (_Loader) {
...
}(core.Loader)) || _class$e);

var _dec$d, _class$d;
(_dec$d = core.resourceLoader(core.AssetType.TextureCube, [""]), _dec$d(_class$d = /*#__PURE__*/function (_Loader) {
...
}(core.Loader)) || _class$d);

var _dec$c, _class$c;
(_dec$c = core.resourceLoader(core.AssetType.SpriteAtlas, ["atlas"], false), _dec$c(_class$c = /*#__PURE__*/function (_Loader) {
    ...
    return new core.AssetPromise(function (resolve, reject) {
      _this.request(item.url, _objectSpread2(_objectSpread2({}, item), {}, {
        ...
        Promise.all(atlasItems.map(function (_ref) {
          ...
          var tempRect = new math.Rect();
          var tempVect2 = new math.Vector2();
          var spriteAtlas = new core.SpriteAtlas(engine);
          ...
          for (var i = 0; i < atlasItemsLen; i++) {
            ...
            var texture = new core.Texture2D(engine, width, height, format);
            ...
            for (var j = sprites.length - 1; j >= 0; j--) {
              ...
              var region = atlasSprite.region,
                  ...
                  id = atlasSprite.id;
              var sprite = new core.Sprite(engine, texture, region ? tempRect.setValue(region.x, region.y, region.w, region.h) : undefined, pivot ? tempVect2.setValue(pivot.x, pivot.y) : undefined, atlasSprite.pixelsPerUnit || undefined, atlasSprite.name);
...
(_dec$b = registerExtension("KHR_draco_mesh_compression"), _dec$b(_class$b = (_temp = _class2 = /*#__PURE__*/function (_ExtensionParser) {
  ...
  _proto.initialize = function initialize() {
    if (!KHR_draco_mesh_compression._decoder) {
      KHR_draco_mesh_compression._decoder = new draco.DRACODecoder();
    }
  };
...
(_dec$a = registerExtension("KHR_lights_punctual"), _dec$a(_class$a = /*#__PURE__*/function (_ExtensionParser) {
  ...
  _proto.parseEngineResource = function parseEngineResource(schema, entity, context) {
    ...
    if (type === "directional") {
      light = entity.addComponent(core.DirectLight);
    } else if (type === "point") {
      light = entity.addComponent(core.PointLight);
    } else if (type === "spot") {
      light = entity.addComponent(core.SpotLight);
    }
    ...
    if (range && !(light instanceof core.DirectLight)) {
      light.distance = range;
    }

    if (spot && light instanceof core.SpotLight) {
...
(_dec$9 = registerExtension("KHR_materials_pbrSpecularGlossiness"), _dec$9(_class$9 = /*#__PURE__*/function (_ExtensionParser) {
  ...
  _proto.createEngineResource = function createEngineResource(schema, context) {
    var engine = context.engine,
        textures = context.textures;
    var material = new core.PBRSpecularMaterial(engine);
...
(_dec$8 = registerExtension("KHR_materials_unlit"), _dec$8(_class$8 = /*#__PURE__*/function (_ExtensionParser) {
  ...
  _proto.createEngineResource = function createEngineResource(schema, context) {
    var engine = context.engine;
    var material = new core.UnlitMaterial(engine);
    return material;
  };
...
(_dec$5 = registerExtension("KHR_texture_transform"), _dec$5(_class$5 = /*#__PURE__*/function (_ExtensionParser) {
  ...
  _proto.parseEngineResource = function parseEngineResource(schema, material, context) {
    ...
    if (rotation) {
      core.Logger.warn("rotation in KHR_texture_transform is not supported now");
    }

    if (texCoord) {
      core.Logger.warn("texCoord in KHR_texture_transform is not supported now");
    }
  };
    ...
    set: function set(value) {
      ...
      if (!this._hasBuiltNode) {
        ...
        if (value !== null) {
          ...
          this._animator = gltfEntity.getComponent(core.Animator);
...
var Model = /*#__PURE__*/function (_MeshRenderer) {
  ...
  function Model(entity) {
    ...
    _this.setMaterial(new core.BlinnPhongMaterial(_this.engine));
  ...
  _proto.setProps = function setProps(props) {
    ...
    switch (props.geometryType) {
      case "Sphere":
        this.mesh = core.PrimitiveMesh.createSphere(this._engine, props.sphereRadius, props.sphereSegments);
        break;

      case "Cylinder":
        this.mesh = core.PrimitiveMesh.createCylinder(this._engine, props.cylinderRadiusTop, props.cylinderRadiusBottom, props.cylinderHeight, props.cylinderRadialSegments, props.cylinderHeightSegments);
        break;

      case "Plane":
        this.mesh = core.PrimitiveMesh.createPlane(this._engine, props.planeWidth, props.planeHeight, props.planeHorizontalSegments, props.planeVerticalSegments);
        break;

      case "Box":
        this.mesh = core.PrimitiveMesh.createCuboid(this._engine, props.boxWidth, props.boxHeight, props.boxDepth);
        break;
    }
  };
...
var sh = new math.SphericalHarmonics3();
...
var AnimatorControllerResource = /*#__PURE__*/function (_SchemaResource) {
  ...
  _proto.load = function load(resourceManager, assetConfig) {
    ...
    return new Promise(function (resolve) {
      ...
      _this2._resource = new core.AnimatorController();
  ...
  _proto._initAnimatorController = function _initAnimatorController(animatorControllerData) {
    ...
    for (var i = 0, length = layers.length; i < length; ++i) {
      ...
      var layer = new core.AnimatorControllerLayer(name);
      layer.blendingMode = blending;
      layer.weight = weight;
      var states = stateMachineData.states;
      var stateMachine = new core.AnimatorStateMachine();
      ...
      for (var _j2 = 0, _length3 = stateMachineTransitions.length; _j2 < _length3; ++_j2) {
        ...
        var _transition = new core.AnimatorStateTransition();
  ...
  _proto.bindMaterials = function bindMaterials(newMaterialsConfig) {
    ...
    for (var i = 0; i < newMaterialsConfig.length; i++) {
      ...
      if (mtlResource) {
        ...
        core.Logger.warn("GLTFResource: " + this.meta.name + " can't find asset \"material\", which id is: " + newMaterialsConfig[i].id);
      }
    }

    var gltfRoot = gltf.defaultSceneRoot;
    var originMaterials = gltf.materials;
    var meshRenderers = gltfRoot.getComponentsIncludeChildren(core.MeshRenderer, []);
...
var SpriteResource = /*#__PURE__*/function (_SchemaResource) {
  ...
  _proto.load = function load(resourceManager, assetConfig) {
    ...
    return new Promise(function (resolve) {
      var assetObj = new core.Sprite(resourceManager.engine);
      _this2.configProps = assetConfig.props;
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (loadPromise) {
        loadPromise.then(function () {
          ...
          getAllGetters(_this3._resource).forEach(function (attr) {
            if (!(sprite[attr] instanceof core.Texture)) return;
    ...
    this.configProps && Object.keys(this.configProps).forEach(function (attr) {
      ...
      if (isAsset(value)) {
        ...
        if (textureResource && textureResource instanceof TextureResource) {
          ...
          resource[attr] = null;
          core.Logger.warn("SpriteResource: " + _this5.meta.name + " can't find asset \"" + attr + "\", which id is: " + value.id);
        }
      } else {
        resource[attr] = value;
      }
...
var SceneManager = (_dec$2 = pluginHook({
  ...
  _proto.setProp = function setProp(field, key, prop) {
    ...
    if (field === "background" && key === "skyboxTexture") {
      ...
      if (prop) {
        sky.mesh = core.PrimitiveMesh.createCuboid(scene.engine, 2, 2, 2);
        var skyMaterial = new core.SkyBoxMaterial(scene.engine);
    ...
    return new Promise(function (resolve) {
      ...
      if (assetConfig.source) {
        resourceManager.load({
          ...
          type: core.AssetType.SpriteAtlas
        ...
        if (!SpriteAtlasResource.defaultAtlas) {
          SpriteAtlasResource.defaultAtlas = new core.SpriteAtlas(resourceManager.engine);
        }
...
var Oasis = (_dec = pluginHook({
  ...
  return Oasis;
}(core.EventDispatcher), (_applyDecoratedDescriptor(_class.prototype, "init", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "init"), _class.prototype)), _class));
