...
var ESP$1 = miniprogram.MathUtil.zeroTolerance; // Spherical.
...
var Spherical = /*#__PURE__*/function () {
  ...
  _proto.makeSafe = function makeSafe() {
    this.phi = miniprogram.MathUtil.clamp(this.phi, ESP$1, Math.PI - ESP$1);
    return this;
  };
  ...
  _proto.setFromVec3 = function setFromVec3(v3) {
    ...
    if (this.radius === 0) {
      ...
      this.phi = Math.acos(miniprogram.MathUtil.clamp(v3.y / this.radius, -1, 1));
    }
...
var FreeControl = /*#__PURE__*/function (_Script) {
  ...
  function FreeControl(entity) {
    ...
    _this._right = new miniprogram.Vector3();
    _this.camera = void 0;
    ...
    _this.domElement = miniprogramAdapter.document;
    ...
    _this._v3Cache = new miniprogram.Vector3();
    ...
    _this._events = [{
      ...
      element: miniprogramAdapter.window
    }, {
      type: "keyup",
  ...
  _proto.onMouseDown = function onMouseDown(event) {
    ...
    if (this.domElement !== miniprogramAdapter.document) {
  ...
  _proto.rotate = function rotate(alpha, beta) {
    ...
    this._theta += miniprogram.MathUtil.degreeToRadian(alpha);
    this._phi += miniprogram.MathUtil.degreeToRadian(beta);
    this._phi = miniprogram.MathUtil.clamp(this._phi, ESP, Math.PI - ESP);
    this._spherical.theta = this._theta;
    this._spherical.phi = this._phi;

    this._spherical.setToVec3(this._v3Cache);

    miniprogram.Vector3.add(this.camera.transform.position, this._v3Cache, this._v3Cache);
    this.camera.transform.lookAt(this._v3Cache, new miniprogram.Vector3(0, 1, 0));
  };
  ...
  _proto.updateSpherical = function updateSpherical() {
    ...
    miniprogram.Vector3.transformByQuat(this._v3Cache, this.camera.rotation, this._v3Cache);
...
var OrbitControl = /*#__PURE__*/function (_Script) {
  ...
  function OrbitControl(entity) {
    ...
    _this.target = new miniprogram.Vector3(); // Up vector

    _this.up = new miniprogram.Vector3(0, 1, 0);
    /**
    ...
    _this._offset = new miniprogram.Vector3();
    _this._spherical = new Spherical();
    ...
    _this._vPan = new miniprogram.Vector3(); // state

    _this._rotateStart = new miniprogram.Vector2();
    _this._rotateEnd = new miniprogram.Vector2();
    _this._rotateDelta = new miniprogram.Vector2();
    _this._panStart = new miniprogram.Vector2();
    _this._panEnd = new miniprogram.Vector2();
    _this._panDelta = new miniprogram.Vector2();
    _this._zoomStart = new miniprogram.Vector2();
    _this._zoomEnd = new miniprogram.Vector2();
    _this._zoomDelta = new miniprogram.Vector2();
    _this.STATE = {
      NONE: -1,
      ROTATE: 0,
      ZOOM: 1,
  ...
  _proto.onDisable = function onDisable() {
    var element = this.domElement === miniprogramAdapter.document ? this.domElement.body : this.domElement;
  ...
  _proto.pan = function pan(deltaX, deltaY) {
    var element = this.domElement === miniprogramAdapter.document ? this.domElement.body : this.domElement; // perspective only
  ...
  _proto.handleMouseMoveRotate = function handleMouseMoveRotate(event) {
    ...
    miniprogram.Vector2.subtract(this._rotateEnd, this._rotateStart, this._rotateDelta);
    var element = this.domElement === miniprogramAdapter.document ? miniprogramAdapter.document.body : this.domElement;
  ...
  _proto.handleMouseMoveZoom = function handleMouseMoveZoom(event) {
    ...
    miniprogram.Vector2.subtract(this._zoomEnd, this._zoomStart, this._zoomDelta);
  ...
  _proto.handleMouseMovePan = function handleMouseMovePan(event) {
    ...
    miniprogram.Vector2.subtract(this._panEnd, this._panStart, this._panDelta);
  ...
  _proto.onMouseUp = function onMouseUp() {
    ...
    this.mouseUpEvents.forEach(function (ele) {
      var element = _this3.domElement === miniprogramAdapter.document ? _this3.domElement.body : _this3.domElement;
...
var OrthoControl = /*#__PURE__*/function (_Script) {
  ...
  function OrthoControl(entity) {
    ...
    _this._panStartPos = new miniprogram.Vector3();
    _this._panStart = new miniprogram.Vector2();
    _this._panEnd = new miniprogram.Vector2();
    _this._panDelta = new miniprogram.Vector2();
    _this.cameraEntity = entity;
    _this.camera = entity.getComponent(miniprogram.Camera);
    return _this;
  }
  ...
  _proto.onUpdate = function onUpdate(dt) {
    ...
    if (this._isPanStart) {
      ...
      miniprogram.Vector2.subtract(panEnd, panStart, panDelta);
  ...
  _proto.panMove = function panMove(x, y) {
    ...
    if (!this._isPanStart) {
      miniprogram.Logger.warn("Make sure to call panStart before calling panMove");
    }
