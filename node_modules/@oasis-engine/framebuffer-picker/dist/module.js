import { Shader, Logger, Vector3, Material, RenderPass, Script, RenderTarget, RenderColorTexture } from 'oasis-engine';
...
var ColorMaterial = /*#__PURE__*/function (_Material) {
  ...
  function ColorMaterial(engine) {
    ...
    _this = _Material.call(this, engine, Shader.find("framebuffer-picker-color")) || this;
    _this._currentId = 0;
  ...
  _proto.id2Color = function id2Color(id) {
    ...
    var color = new Vector3((id & 0xff) / 255, ((id & 0xff00) >> 8) / 255, ((id & 0xff0000) >> 16) / 255);
    return color;
  }
  /**
...
var FramebufferPicker = /*#__PURE__*/function (_Script) {
  ...
  function FramebufferPicker(entity) {
    ...
    var width = 1024;
    var height = 1024;
    _this.colorRenderTarget = new RenderTarget(_this.engine, width, height, new RenderColorTexture(_this.engine, width, height));
