...
miniprogram.Shader.create("framebuffer-picker-color", vs, fs);
/**
...
var ColorMaterial = /*#__PURE__*/function (_Material) {
  ...
  function ColorMaterial(engine) {
    ...
    _this = _Material.call(this, engine, miniprogram.Shader.find("framebuffer-picker-color")) || this;
    _this._currentId = 0;
  ...
  _proto.id2Color = function id2Color(id) {
    if (id >= 0xffffff) {
      ...
      return new miniprogram.Vector3(0, 0, 0);
    }

    var color = new miniprogram.Vector3((id & 0xff) / 255, ((id & 0xff00) >> 8) / 255, ((id & 0xff0000) >> 16) / 255);
    return color;
  }
  /**
...
var FramebufferPicker = /*#__PURE__*/function (_Script) {
  ...
  function FramebufferPicker(entity) {
    ...
    var width = 1024;
    var height = 1024;
    _this.colorRenderTarget = new miniprogram.RenderTarget(_this.engine, width, height, new miniprogram.RenderColorTexture(_this.engine, width, height));
