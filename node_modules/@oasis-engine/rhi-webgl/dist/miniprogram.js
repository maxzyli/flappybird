...
var miniprogram$1 = require('@oasis-engine/core/dist/miniprogram');
...
var WebCanvas = /*#__PURE__*/function () {
  ...
  _proto.resizeByClientSize = function resizeByClientSize(pixelRatio) {
    if (pixelRatio === void 0) {
      pixelRatio = miniprogramAdapter.window.devicePixelRatio;
    }

    var webCanvas = this._webCanvas;

    if (webCanvas instanceof miniprogramAdapter.HTMLCanvasElement) {
  ...
  _createClass(WebCanvas, [{
    ...
    get: function get() {
      ...
      if (webCanvas instanceof miniprogramAdapter.HTMLCanvasElement) {
        this._scale.setValue(webCanvas.clientWidth * miniprogramAdapter.devicePixelRatio / webCanvas.width, webCanvas.clientHeight * miniprogramAdapter.devicePixelRatio / webCanvas.height);
      }
...
var GLCapability = /*#__PURE__*/function () {
  ...
  _proto._init = function _init() {
    ...
    var shaderVertexID = miniprogram$1.GLCapabilityType.shaderVertexID,
        standardDerivatives = miniprogram$1.GLCapabilityType.standardDerivatives,
        shaderTextureLod = miniprogram$1.GLCapabilityType.shaderTextureLod,
        elementIndexUint = miniprogram$1.GLCapabilityType.elementIndexUint,
        depthTexture = miniprogram$1.GLCapabilityType.depthTexture,
        vertexArrayObject = miniprogram$1.GLCapabilityType.vertexArrayObject,
        instancedArrays = miniprogram$1.GLCapabilityType.instancedArrays,
        multipleSample = miniprogram$1.GLCapabilityType.multipleSample,
        drawBuffers = miniprogram$1.GLCapabilityType.drawBuffers,
        astc = miniprogram$1.GLCapabilityType.astc,
        astc_webkit = miniprogram$1.GLCapabilityType.astc_webkit,
        etc = miniprogram$1.GLCapabilityType.etc,
        etc_webkit = miniprogram$1.GLCapabilityType.etc_webkit,
        etc1 = miniprogram$1.GLCapabilityType.etc1,
        etc1_webkit = miniprogram$1.GLCapabilityType.etc1_webkit,
        pvrtc = miniprogram$1.GLCapabilityType.pvrtc,
        pvrtc_webkit = miniprogram$1.GLCapabilityType.pvrtc_webkit,
        s3tc = miniprogram$1.GLCapabilityType.s3tc,
        s3tc_webkit = miniprogram$1.GLCapabilityType.s3tc_webkit,
        textureFloat = miniprogram$1.GLCapabilityType.textureFloat,
        textureHalfFloat = miniprogram$1.GLCapabilityType.textureHalfFloat,
        textureFloatLinear = miniprogram$1.GLCapabilityType.textureFloatLinear,
        textureHalfFloatLinear = miniprogram$1.GLCapabilityType.textureHalfFloatLinear,
        WEBGL_colorBufferFloat = miniprogram$1.GLCapabilityType.WEBGL_colorBufferFloat,
        colorBufferFloat = miniprogram$1.GLCapabilityType.colorBufferFloat,
        colorBufferHalfFloat = miniprogram$1.GLCapabilityType.colorBufferHalfFloat,
        textureFilterAnisotropic = miniprogram$1.GLCapabilityType.textureFilterAnisotropic;
  ...
  _proto._compatibleAllInterface = function _compatibleAllInterface() {
    var depthTexture = miniprogram$1.GLCapabilityType.depthTexture,
        vertexArrayObject = miniprogram$1.GLCapabilityType.vertexArrayObject,
        instancedArrays = miniprogram$1.GLCapabilityType.instancedArrays,
        drawBuffers = miniprogram$1.GLCapabilityType.drawBuffers,
        textureFilterAnisotropic = miniprogram$1.GLCapabilityType.textureFilterAnisotropic,
...
var GLPrimitive = /*#__PURE__*/function () {
  function GLPrimitive(rhi, primitive) {
    ...
    this.canUseInstancedArrays = rhi.canIUse(miniprogram$1.GLCapabilityType.instancedArrays);
...
var GLTexture = /*#__PURE__*/function () {
  ...
  GLTexture._getRenderBufferColorFormatDetail = function _getRenderBufferColorFormatDetail(format, gl, isWebGL2) {
    switch (format) {
      case miniprogram$1.RenderBufferColorFormat.R8G8B8:
        return {
          internalFormat: isWebGL2 ? gl.RGB8 : gl.RGB,
          baseFormat: gl.RGB,
          dataType: gl.UNSIGNED_BYTE,
      ...
      case miniprogram$1.RenderBufferColorFormat.R8G8B8A8:
        return {
          internalFormat: isWebGL2 ? gl.RGBA8 : gl.RGBA,
          baseFormat: gl.RGBA,
          dataType: gl.UNSIGNED_BYTE,
      ...
      case miniprogram$1.RenderBufferColorFormat.R4G4B4A4:
        return {
          internalFormat: isWebGL2 ? gl.RGBA4 : gl.RGBA,
          baseFormat: gl.RGBA,
          dataType: gl.UNSIGNED_SHORT_4_4_4_4,
      ...
      case miniprogram$1.RenderBufferColorFormat.R5G5B5A1:
        return {
          internalFormat: isWebGL2 ? gl.RGB5_A1 : gl.RGBA,
          baseFormat: gl.RGBA,
          dataType: gl.UNSIGNED_SHORT_5_5_5_1,
      ...
      case miniprogram$1.RenderBufferColorFormat.R5G6B5:
        return {
          internalFormat: isWebGL2 ? gl.RGB565 : gl.RGB,
          baseFormat: gl.RGB,
          dataType: gl.UNSIGNED_SHORT_5_6_5,
      ...
      case miniprogram$1.RenderBufferColorFormat.Alpha8:
        return {
          internalFormat: gl.ALPHA,
          baseFormat: gl.ALPHA,
          dataType: gl.UNSIGNED_BYTE,
      ...
      case miniprogram$1.RenderBufferColorFormat.R16G16B16A16:
        return {
      ...
      case miniprogram$1.RenderBufferColorFormat.R32G32B32A32:
        return {
          internalFormat: gl.RGBA32F,
          baseFormat: gl.RGBA,
          dataType: gl.FLOAT,
  ...
  GLTexture._supportRenderBufferDepthFormat = function _supportRenderBufferDepthFormat(format, rhi, isTexture) {
    ...
    if (isTexture && !rhi.canIUse(miniprogram$1.GLCapabilityType.depthTexture)) {
      return false;
    }
...
var GLRenderColorTexture = /*#__PURE__*/function (_GLTexture) {
  ...
  function GLRenderColorTexture(rhi, texture) {
    ...
    if (!GLTexture._supportRenderBufferColorFormat(format, rhi)) {
      throw new Error("RenderBufferColorFormat is not supported:" + miniprogram$1.RenderBufferColorFormat[format]);
    }
...
var GLRenderDepthTexture = /*#__PURE__*/function (_GLTexture) {
  ...
  function GLRenderDepthTexture(rhi, texture) {
    ...
    if (!GLTexture._supportRenderBufferDepthFormat(format, rhi, true)) {
      throw new Error("RenderBufferDepthFormat is not supported:" + miniprogram$1.RenderBufferDepthFormat[format]);
    }
...
var GLRenderTarget = /*#__PURE__*/function () {
  ...
  function GLRenderTarget(rhi, target) {
    ...
    if (!(_depth instanceof miniprogram$1.RenderDepthTexture) && !GLTexture._supportRenderBufferDepthFormat(_depth, rhi, false)) {
      throw new Error("RenderBufferDepthFormat is not supported:" + miniprogram$1.RenderBufferDepthFormat[_depth]);
    }
    ...
    if (_depth instanceof miniprogram$1.RenderDepthTexture && (_depth.width !== width || _depth.height !== height)) {
  ...
  _proto._bindMainFBO = function _bindMainFBO() {
    ...
    if (_depth !== null) {
      if (_depth instanceof miniprogram$1.RenderDepthTexture) {
  ...
  _proto._bindMSAAFBO = function _bindMSAAFBO() {
    ...
    if (_depth !== null) {
      var _ref = _depth instanceof miniprogram$1.RenderDepthTexture ?
      /** @ts-ignore */
...
var WebGLRenderer = /*#__PURE__*/function () {
  ...
  _proto.init = function init(canvas) {
    ...
    if (webGLMode == exports.WebGLMode.Auto || webGLMode == exports.WebGLMode.WebGL2) {
      ...
      if (!gl && webCanvas instanceof miniprogramAdapter.HTMLCanvasElement) {
  ...
  _proto.clearRenderTarget = function clearRenderTarget(engine, clearFlags, clearColor) {
    ...
    if (clearFlags === miniprogram$1.CameraClearFlags.DepthColor) {
...
var WebGLEngine = /*#__PURE__*/function (_Engine) {
  ...
  function WebGLEngine(canvas, webGLRendererOptions) {
    var webCanvas = new WebCanvas(typeof canvas === "string" ? miniprogramAdapter.document.getElementById(canvas) : canvas);
