...
var GLCapability = /*#__PURE__*/function () {
  ...
  _proto._init = function _init() {
    ...
    var shaderVertexID = core.GLCapabilityType.shaderVertexID,
        standardDerivatives = core.GLCapabilityType.standardDerivatives,
  ...
  _createClass(GLCapability, [{
    ...
    get: function get() {
      return this.canIUse(core.GLCapabilityType.shaderVertexID) && this.canIUse(core.GLCapabilityType.textureFloat) && this.rhi.renderStates.getParameter(this.rhi.gl.MAX_VERTEX_TEXTURE_IMAGE_UNITS) > 0;
    }
    /**
...
var GLTexture = /*#__PURE__*/function () {
  ...
  GLTexture._getFormatDetail = function _getFormatDetail(format, gl, isWebGL2) {
    switch (format) {
      case core.TextureFormat.R8G8B8:
        return {
      ...
      case core.TextureFormat.R8G8B8A8:
        return {
      ...
      case core.TextureFormat.R4G4B4A4:
        return {
      ...
      case core.TextureFormat.R5G5B5A1:
        return {
      ...
      case core.TextureFormat.R5G6B5:
        return {
      ...
      case core.TextureFormat.Alpha8:
        return {
      ...
      case core.TextureFormat.LuminanceAlpha:
        return {
      ...
      case core.TextureFormat.R32G32B32A32:
        return {
  ...
  GLTexture._getRenderBufferColorFormatDetail = function _getRenderBufferColorFormatDetail(format, gl, isWebGL2) {
    switch (format) {
      case core.RenderBufferColorFormat.R8G8B8:
        return {
          internalFormat: isWebGL2 ? gl.RGB8 : gl.RGB,
          baseFormat: gl.RGB,
          dataType: gl.UNSIGNED_BYTE,
      ...
      case core.RenderBufferColorFormat.R8G8B8A8:
        return {
          internalFormat: isWebGL2 ? gl.RGBA8 : gl.RGBA,
          baseFormat: gl.RGBA,
          dataType: gl.UNSIGNED_BYTE,
      ...
      case core.RenderBufferColorFormat.R4G4B4A4:
        return {
          internalFormat: isWebGL2 ? gl.RGBA4 : gl.RGBA,
          baseFormat: gl.RGBA,
          dataType: gl.UNSIGNED_SHORT_4_4_4_4,
      ...
      case core.RenderBufferColorFormat.R5G5B5A1:
        return {
          internalFormat: isWebGL2 ? gl.RGB5_A1 : gl.RGBA,
          baseFormat: gl.RGBA,
          dataType: gl.UNSIGNED_SHORT_5_5_5_1,
      ...
      case core.RenderBufferColorFormat.R5G6B5:
        return {
          internalFormat: isWebGL2 ? gl.RGB565 : gl.RGB,
          baseFormat: gl.RGB,
          dataType: gl.UNSIGNED_SHORT_5_6_5,
      ...
      case core.RenderBufferColorFormat.Alpha8:
        return {
          internalFormat: gl.ALPHA,
          baseFormat: gl.ALPHA,
          dataType: gl.UNSIGNED_BYTE,
      ...
      case core.RenderBufferColorFormat.R16G16B16A16:
        return {
      ...
      case core.RenderBufferColorFormat.R32G32B32A32:
        return {
          internalFormat: gl.RGBA32F,
          baseFormat: gl.RGBA,
          dataType: gl.FLOAT,
  ...
  GLTexture._getRenderBufferDepthFormatDetail = function _getRenderBufferDepthFormatDetail(format, gl, isWebGL2) {
    switch (format) {
      case core.RenderBufferDepthFormat.Depth:
        return {
      ...
      case core.RenderBufferDepthFormat.DepthStencil:
        return {
      ...
      case core.RenderBufferDepthFormat.Stencil:
        return {
      ...
      case core.RenderBufferDepthFormat.Depth16:
        return {
      ...
      case core.RenderBufferDepthFormat.Depth24:
        return {
      ...
      case core.RenderBufferDepthFormat.Depth32:
        return {
      ...
      case core.RenderBufferDepthFormat.Depth24Stencil8:
        return {
          internalFormat: isWebGL2 ? gl.DEPTH24_STENCIL8 : gl.DEPTH_STENCIL,
          baseFormat: gl.DEPTH_STENCIL,
          dataType: gl.UNSIGNED_INT_24_8,
      ...
      case core.RenderBufferDepthFormat.Depth32Stencil8:
        return {
  ...
  GLTexture._supportTextureFormat = function _supportTextureFormat(format, rhi) {
    ...
    switch (format) {
      case core.TextureFormat.R32G32B32A32:
        {
          if (!rhi.canIUse(core.GLCapabilityType.textureFloat)) {
            isSupported = false;
          }
        }
        break;
  ...
  GLTexture._supportRenderBufferColorFormat = function _supportRenderBufferColorFormat(format, rhi) {
    ...
    switch (format) {
      case core.RenderBufferColorFormat.R32G32B32A32:
        {
          if (!rhi.canIUse(core.GLCapabilityType.colorBufferFloat) || !rhi.canIUse(core.GLCapabilityType.textureFloat)) {
            isSupported = false;
          }
        }
        break;
      ...
      case core.RenderBufferColorFormat.R16G16B16A16:
        {
          if (!rhi.canIUse(core.GLCapabilityType.colorBufferHalfFloat) || !rhi.canIUse(core.GLCapabilityType.textureHalfFloat)) {
            isSupported = false;
          }
        }
        break;
  ...
  GLTexture._supportRenderBufferDepthFormat = function _supportRenderBufferDepthFormat(format, rhi, isTexture) {
    ...
    if (isTexture && !rhi.canIUse(core.GLCapabilityType.depthTexture)) {
      return false;
    }
  ...
  _proto._setWrapMode = function _setWrapMode(value, pname) {
    ...
    if (!isWebGL2 && value !== core.TextureWrapMode.Clamp && (!GLTexture._isPowerOf2(width) || !GLTexture._isPowerOf2(height))) {
      core.Logger.warn("non-power-2 texture is not supported for REPEAT or MIRRORED_REPEAT in WebGL1,and has automatically downgraded to CLAMP_TO_EDGE");
      value = core.TextureWrapMode.Clamp;
    }
...
var GLRenderColorTexture = /*#__PURE__*/function (_GLTexture) {
  ...
  function GLRenderColorTexture(rhi, texture) {
    ...
    if (!GLTexture._supportRenderBufferColorFormat(format, rhi)) {
      throw new Error("RenderBufferColorFormat is not supported:" + core.RenderBufferColorFormat[format]);
    }
    ...
    if (_mipmap && !isWebGL2 && (!GLTexture._isPowerOf2(width) || !GLTexture._isPowerOf2(height))) {
      core.Logger.warn("non-power-2 texture is not supported for mipmap in WebGL1,and has automatically downgraded to non-mipmap");
      /** @ts-ignore */
...
var GLRenderDepthTexture = /*#__PURE__*/function (_GLTexture) {
  ...
  function GLRenderDepthTexture(rhi, texture) {
    ...
    if (!GLTexture._supportRenderBufferDepthFormat(format, rhi, true)) {
      throw new Error("RenderBufferDepthFormat is not supported:" + core.RenderBufferDepthFormat[format]);
    }
...
var GLRenderTarget = /*#__PURE__*/function () {
  ...
  function GLRenderTarget(rhi, target) {
    ...
    if (!(_depth instanceof core.RenderDepthTexture) && !GLTexture._supportRenderBufferDepthFormat(_depth, rhi, false)) {
      throw new Error("RenderBufferDepthFormat is not supported:" + core.RenderBufferDepthFormat[_depth]);
    }

    if (_colorTextures.length > 1 && !rhi.canIUse(core.GLCapabilityType.drawBuffers)) {
    ...
    if (_depth instanceof core.RenderDepthTexture && (_depth.width !== width || _depth.height !== height)) {
    ...
    if (target.antiAliasing > maxAntiAliasing) {
      core.Logger.warn("MSAA antiAliasing exceeds the limit and is automatically downgraded to:" + maxAntiAliasing);
      /** @ts-ignore */
  ...
  _proto._bindMainFBO = function _bindMainFBO() {
    ...
    if (_depth !== null) {
      if (_depth instanceof core.RenderDepthTexture) {
  ...
  _proto._bindMSAAFBO = function _bindMSAAFBO() {
    ...
    if (_depth !== null) {
      var _ref = _depth instanceof core.RenderDepthTexture ?
      /** @ts-ignore */
...
var GLTexture2D = /*#__PURE__*/function (_GLTexture) {
  ...
  function GLTexture2D(rhi, texture2D) {
    ...
    if (!GLTexture._supportTextureFormat(format, rhi)) {
      throw new Error("Texture format is not supported:" + core.TextureFormat[format]);
    }
...
var WebGLRenderer = /*#__PURE__*/function () {
  function WebGLRenderer(options) {
    ...
    this._lastViewport = new math.Vector4(null, null, null, null);
    this._lastClearColor = new math.Color(null, null, null, null);
  ...
  _proto.clearRenderTarget = function clearRenderTarget(engine, clearFlags, clearColor) {
    ...
    if (clearFlags === core.CameraClearFlags.DepthColor) {
      ...
      if (targetBlendState.colorWriteMask !== core.ColorWriteMask.All) {
        gl.colorMask(true, true, true, true);
