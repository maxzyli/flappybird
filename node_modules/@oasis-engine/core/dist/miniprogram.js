  ...
  _proto.callRender = function callRender(context) {
    ...
    for (var i = this._renderers.length - 1; i >= 0; --i) {
      ...
      if (camera.isOrthographic) {
        ...
        miniprogram.Vector3.subtract(center, position, center);
        element._distanceForSort = miniprogram.Vector3.dot(center, forward);
      } else {
        element._distanceForSort = miniprogram.Vector3.distanceSquared(center, position);
      }
...
ComponentsManager._tempVector0 = new miniprogram.Vector3();
ComponentsManager._tempVector1 = new miniprogram.Vector3();
...
var Transform = (_class$8 = (_temp$7 = _class2$7 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Transform, [{
    ...
    get: function get() {
      if (this._isContainDirtyFlag(TransformFlag.LocalEuler)) {
        ...
        this._rotation.scale(miniprogram.MathUtil.radToDegreeFactor); // radians to degrees
    ...
    get: function get() {
      if (this._isContainDirtyFlag(TransformFlag.WorldEuler)) {
        ...
        this._worldRotation.scale(miniprogram.MathUtil.radToDegreeFactor); // Radian to angle
  ...
  return Transform;
}(Component), _class2$7._tempQuat0 = new miniprogram.Quaternion(), _class2$7._tempVec3 = new miniprogram.Vector3(), _class2$7._tempMat30 = new miniprogram.Matrix3x3(), _class2$7._tempMat31 = new miniprogram.Matrix3x3(), _class2$7._tempMat32 = new miniprogram.Matrix3x3(), _class2$7._tempMat40 = new miniprogram.Matrix(), _class2$7._tempMat41 = new miniprogram.Matrix(), _class2$7._tempMat42 = new miniprogram.Matrix(), _class2$7._tempMat43 = new miniprogram.Matrix(), _temp$7), (_descriptor$8 = _applyDecoratedDescriptor(_class$8.prototype, "_position", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
      ...
      switch (type) {
        ...
        case gl.FLOAT_VEC2:
          if (isArray) {
            ...
            shaderUniform.cacheValue = new miniprogram.Vector2(0, 0);
          }
        ...
        case gl.FLOAT_VEC4:
          if (isArray) {
            ...
            shaderUniform.cacheValue = new miniprogram.Vector4(0, 0, 0, 0);
          }
        ...
        case gl.INT_VEC4:
          if (isArray) {
            ...
            shaderUniform.cacheValue = new miniprogram.Vector4(0, 0, 0);
          }
...
var BlendState = /*#__PURE__*/function () {
  function BlendState() {
    ...
    this.blendColor = new miniprogram.Color(0, 0, 0, 0);
  ...
  BlendState._getGLBlendOperation = function _getGLBlendOperation(rhi, blendOperation) {
    ...
    switch (blendOperation) {
      ...
      case exports.BlendOperation.Min:
        if (!rhi.canIUse(exports.GLCapabilityType.blendMinMax)) {
  ...
  _proto._platformApply = function _platformApply(rhi, lastState) {
    ...
    if (enabled) {
      ...
      if (!miniprogram.Color.equals(lastState.blendColor, blendColor)) {
...
var RenderContext = /*#__PURE__*/function () {
  function RenderContext() {
    this._camera = void 0;
    this._viewProjectMatrix = new miniprogram.Matrix();
  }
  ...
  _proto._setContext = function _setContext(camera) {
    this._camera = camera;
    miniprogram.Matrix.multiply(camera.projectionMatrix, camera.viewMatrix, this._viewProjectMatrix);
  };
...
var Renderer = (_class$7 = (_temp$6 = _class2$6 = /*#__PURE__*/function (_Component) {
  ...
  _proto._updateShaderData = function _updateShaderData(context) {
    ...
    miniprogram.Matrix.multiply(context._camera.viewMatrix, worldMatrix, mvMatrix);
    miniprogram.Matrix.multiply(context._viewProjectMatrix, worldMatrix, mvpMatrix);
...
})(exports.SpriteMaskLayer || (exports.SpriteMaskLayer = {}));
...
var SpriteMask = (_class$6 = (_temp$5 = _class2$5 = /*#__PURE__*/function (_Renderer) {
  ...
  _proto._render = function _render(camera) {
    ...
    if (this._worldMatrixDirtyFlag.flag || localDirty || this._isSpriteDirty) {
      ...
      for (var i = 0, n = positions.length; i < n; i++) {
        ...
        miniprogram.Vector3.transformToVec3(localVertexPos, worldMatrix, positions[i]);
      }
  ...
  return SpriteMask;
}(Renderer), _class2$5._textureProperty = Shader.getPropertyByName("u_maskTexture"), _class2$5._alphaCutoffProperty = Shader.getPropertyByName("u_maskAlphaCutoff"), _class2$5._tempVec3 = new miniprogram.Vector3(), _temp$5), (_descriptor$6 = _applyDecoratedDescriptor(_class$6.prototype, "_positions", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return [new miniprogram.Vector3(), new miniprogram.Vector3(), new miniprogram.Vector3(), new miniprogram.Vector3()];
  }
  ...
  writable: true,
  initializer: function initializer() {
    return exports.SpriteMaskLayer.Everything;
  }
})), _class$6);
  ...
  BufferUtil._getElementInfo = function _getElementInfo(format) {
    ...
    switch (format) {
      ...
      case exports.VertexElementFormat.Byte4:
        size = 4;
        type = exports.DataType.BYTE;
        break;

      case exports.VertexElementFormat.UByte4:
        size = 4;
        type = exports.DataType.UNSIGNED_BYTE;
        break;

      case exports.VertexElementFormat.NormalizedByte4:
        size = 4;
        type = exports.DataType.BYTE;
        normalized = true;
        break;

      case exports.VertexElementFormat.NormalizedUByte4:
        size = 4;
        type = exports.DataType.UNSIGNED_BYTE;
        normalized = true;
        break;
      ...
      case exports.VertexElementFormat.NormalizedShort2:
        size = 2;
        type = exports.DataType.SHORT;
        normalized = true;
        break;

      case exports.VertexElementFormat.NormalizedUShort2:
        size = 2;
        type = exports.DataType.UNSIGNED_SHORT;
        normalized = true;
        break;
      ...
      case exports.VertexElementFormat.NormalizedShort4:
        size = 4;
        type = exports.DataType.SHORT;
        normalized = true;
        break;

      case exports.VertexElementFormat.NormalizedUShort4:
        size = 4;
        type = exports.DataType.UNSIGNED_SHORT;
        normalized = true;
        break;
...
function SubMesh(start, count, topology) {
  ...
  if (topology === void 0) {
    topology = exports.MeshTopology.Triangles;
  }
...
var Mesh = /*#__PURE__*/function (_RefObject) {
  ...
  function Mesh(engine, name) {
    ...
    _this = _RefObject.call(this, engine) || this;
    _this.name = void 0;
    _this.bounds = new miniprogram.BoundingBox();
...
var ModelMesh = /*#__PURE__*/function (_Mesh) {
  ...
  _proto.uploadData = function uploadData(noLongerAccessible) {
    ...
    if (!vertexBuffer || this._verticesFloat32.length !== vertexFloatCount) {
      ...
      var newVertexBuffer = new Buffer(this._engine, exports.BufferBindFlag.VertexBuffer, vertices, noLongerAccessible ? exports.BufferUsage.Static : exports.BufferUsage.Dynamic);
    ...
    if (_indices) {
      if (!indexBuffer || _indices.byteLength != indexBuffer.byteLength) {
        ...
        var newIndexBuffer = new Buffer(this._engine, exports.BufferBindFlag.IndexBuffer, _indices);
  ...
  _proto._updateVertexElements = function _updateVertexElements() {
    ...
    if (this._normals) {
      vertexElements.push(new VertexElement("NORMAL", offset, exports.VertexElementFormat.Vector3, 0));
      offset += 12;
      elementCount += 3;
    }

    if (this._colors) {
      vertexElements.push(new VertexElement("COLOR_0", offset, exports.VertexElementFormat.Vector4, 0));
      offset += 16;
      elementCount += 4;
    }

    if (this._boneWeights) {
      vertexElements.push(new VertexElement("WEIGHTS_0", offset, exports.VertexElementFormat.Vector4, 0));
      offset += 16;
      elementCount += 4;
    }

    if (this._boneIndices) {
      vertexElements.push(new VertexElement("JOINTS_0", offset, exports.VertexElementFormat.UByte4, 0));
      offset += 4;
      elementCount += 1;
    }

    if (this._tangents) {
      vertexElements.push(new VertexElement("TANGENT", offset, exports.VertexElementFormat.Vector4, 0));
      offset += 16;
      elementCount += 4;
    }

    if (this._uv) {
      vertexElements.push(new VertexElement("TEXCOORD_0", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv1) {
      vertexElements.push(new VertexElement("TEXCOORD_1", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv2) {
      vertexElements.push(new VertexElement("TEXCOORD_2", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv3) {
      vertexElements.push(new VertexElement("TEXCOORD_3", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv4) {
      vertexElements.push(new VertexElement("TEXCOORD_4", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv5) {
      vertexElements.push(new VertexElement("TEXCOORD_5", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv6) {
      vertexElements.push(new VertexElement("TEXCOORD_6", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }

    if (this._uv7) {
      vertexElements.push(new VertexElement("TEXCOORD_7", offset, exports.VertexElementFormat.Vector2, 0));
      offset += 8;
      elementCount += 2;
    }
    ...
    for (var i = 0, n = blendShapeCount; i < n; i++) {
      vertexElements.push(new VertexElement("POSITION_BS" + i, offset, exports.VertexElementFormat.Vector3, 0));
      offset += 12;
      elementCount += 3;

      if (this._useBlendShapeNormal) {
        vertexElements.push(new VertexElement("NORMAL_BS" + i, offset, exports.VertexElementFormat.Vector3, 0));
        offset += 12;
        elementCount += 3;
      }

      if (this._useBlendShapeTangent) {
        vertexElements.push(new VertexElement("TANGENT_BS" + i, offset, exports.VertexElementFormat.Vector3, 0));
        offset += 12;
        elementCount += 3;
      }
    }
...
var POSITION_VERTEX_ELEMENT = new VertexElement("POSITION", 0, exports.VertexElementFormat.Vector3, 0);
var ValueChanged;
...
var PrimitiveMesh = /*#__PURE__*/function () {
  ...
  PrimitiveMesh.createSphere = function createSphere(engine, radius, segments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      positions[i] = new miniprogram.Vector3(posX, posY, posZ); // Normal

      normals[i] = new miniprogram.Vector3(posX, posY, posZ); // Texcoord

      uvs[i] = new miniprogram.Vector2(u, v);
    }
  ...
  PrimitiveMesh.createCuboid = function createCuboid(engine, width, height, depth, noLongerAccessible) {
    ...
    positions[0] = new miniprogram.Vector3(-halfWidth, halfHeight, -halfDepth);
    positions[1] = new miniprogram.Vector3(halfWidth, halfHeight, -halfDepth);
    positions[2] = new miniprogram.Vector3(halfWidth, halfHeight, halfDepth);
    positions[3] = new miniprogram.Vector3(-halfWidth, halfHeight, halfDepth);
    normals[0] = new miniprogram.Vector3(0, 1, 0);
    normals[1] = new miniprogram.Vector3(0, 1, 0);
    normals[2] = new miniprogram.Vector3(0, 1, 0);
    normals[3] = new miniprogram.Vector3(0, 1, 0);
    uvs[0] = new miniprogram.Vector2(0, 0);
    uvs[1] = new miniprogram.Vector2(1, 0);
    uvs[2] = new miniprogram.Vector2(1, 1);
    uvs[3] = new miniprogram.Vector2(0, 1); // Down

    positions[4] = new miniprogram.Vector3(-halfWidth, -halfHeight, -halfDepth);
    positions[5] = new miniprogram.Vector3(halfWidth, -halfHeight, -halfDepth);
    positions[6] = new miniprogram.Vector3(halfWidth, -halfHeight, halfDepth);
    positions[7] = new miniprogram.Vector3(-halfWidth, -halfHeight, halfDepth);
    normals[4] = new miniprogram.Vector3(0, -1, 0);
    normals[5] = new miniprogram.Vector3(0, -1, 0);
    normals[6] = new miniprogram.Vector3(0, -1, 0);
    normals[7] = new miniprogram.Vector3(0, -1, 0);
    uvs[4] = new miniprogram.Vector2(0, 1);
    uvs[5] = new miniprogram.Vector2(1, 1);
    uvs[6] = new miniprogram.Vector2(1, 0);
    uvs[7] = new miniprogram.Vector2(0, 0); // Left

    positions[8] = new miniprogram.Vector3(-halfWidth, halfHeight, -halfDepth);
    positions[9] = new miniprogram.Vector3(-halfWidth, halfHeight, halfDepth);
    positions[10] = new miniprogram.Vector3(-halfWidth, -halfHeight, halfDepth);
    positions[11] = new miniprogram.Vector3(-halfWidth, -halfHeight, -halfDepth);
    normals[8] = new miniprogram.Vector3(-1, 0, 0);
    normals[9] = new miniprogram.Vector3(-1, 0, 0);
    normals[10] = new miniprogram.Vector3(-1, 0, 0);
    normals[11] = new miniprogram.Vector3(-1, 0, 0);
    uvs[8] = new miniprogram.Vector2(0, 0);
    uvs[9] = new miniprogram.Vector2(1, 0);
    uvs[10] = new miniprogram.Vector2(1, 1);
    uvs[11] = new miniprogram.Vector2(0, 1); // Right

    positions[12] = new miniprogram.Vector3(halfWidth, halfHeight, -halfDepth);
    positions[13] = new miniprogram.Vector3(halfWidth, halfHeight, halfDepth);
    positions[14] = new miniprogram.Vector3(halfWidth, -halfHeight, halfDepth);
    positions[15] = new miniprogram.Vector3(halfWidth, -halfHeight, -halfDepth);
    normals[12] = new miniprogram.Vector3(1, 0, 0);
    normals[13] = new miniprogram.Vector3(1, 0, 0);
    normals[14] = new miniprogram.Vector3(1, 0, 0);
    normals[15] = new miniprogram.Vector3(1, 0, 0);
    uvs[12] = new miniprogram.Vector2(1, 0);
    uvs[13] = new miniprogram.Vector2(0, 0);
    uvs[14] = new miniprogram.Vector2(0, 1);
    uvs[15] = new miniprogram.Vector2(1, 1); // Front

    positions[16] = new miniprogram.Vector3(-halfWidth, halfHeight, halfDepth);
    positions[17] = new miniprogram.Vector3(halfWidth, halfHeight, halfDepth);
    positions[18] = new miniprogram.Vector3(halfWidth, -halfHeight, halfDepth);
    positions[19] = new miniprogram.Vector3(-halfWidth, -halfHeight, halfDepth);
    normals[16] = new miniprogram.Vector3(0, 0, 1);
    normals[17] = new miniprogram.Vector3(0, 0, 1);
    normals[18] = new miniprogram.Vector3(0, 0, 1);
    normals[19] = new miniprogram.Vector3(0, 0, 1);
    uvs[16] = new miniprogram.Vector2(0, 0);
    uvs[17] = new miniprogram.Vector2(1, 0);
    uvs[18] = new miniprogram.Vector2(1, 1);
    uvs[19] = new miniprogram.Vector2(0, 1); // Back

    positions[20] = new miniprogram.Vector3(-halfWidth, halfHeight, -halfDepth);
    positions[21] = new miniprogram.Vector3(halfWidth, halfHeight, -halfDepth);
    positions[22] = new miniprogram.Vector3(halfWidth, -halfHeight, -halfDepth);
    positions[23] = new miniprogram.Vector3(-halfWidth, -halfHeight, -halfDepth);
    normals[20] = new miniprogram.Vector3(0, 0, -1);
    normals[21] = new miniprogram.Vector3(0, 0, -1);
    normals[22] = new miniprogram.Vector3(0, 0, -1);
    normals[23] = new miniprogram.Vector3(0, 0, -1);
    uvs[20] = new miniprogram.Vector2(1, 0);
    uvs[21] = new miniprogram.Vector2(0, 0);
    uvs[22] = new miniprogram.Vector2(0, 1);
    uvs[23] = new miniprogram.Vector2(1, 1);
  ...
  PrimitiveMesh.createPlane = function createPlane(engine, width, height, horizontalSegments, verticalSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      positions[i] = new miniprogram.Vector3(x * gridWidth - halfWidth, y * gridHeight - halfHeight, 0); // Normal

      normals[i] = new miniprogram.Vector3(0, 0, 1); // Texcoord

      uvs[i] = new miniprogram.Vector2(x * horizontalSegmentsReciprocal, 1 - y * verticalSegmentsReciprocal);
    }
  ...
  PrimitiveMesh.createCylinder = function createCylinder(engine, radiusTop, radiusBottom, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < torsoVertexCount; ++i) {
      ...
      normals[i] = new miniprogram.Vector3(sinTheta, slope, cosTheta); // Texcoord

      uvs[i] = new miniprogram.Vector2(u, 1 - v);
    }
    ...
    positions[torsoVertexCount] = new miniprogram.Vector3(0, -halfHeight, 0); // Bottom normal

    normals[torsoVertexCount] = new miniprogram.Vector3(0, -1, 0); // Bottom texcoord

    uvs[torsoVertexCount] = new miniprogram.Vector2(0.5, 0.5); // Top position

    positions[torsoVertexCount + 1] = new miniprogram.Vector3(0, halfHeight, 0); // Top normal

    normals[torsoVertexCount + 1] = new miniprogram.Vector3(0, 1, 0); // Top texcoord

    uvs[torsoVertexCount + 1] = new miniprogram.Vector2(0.5, 0.5); // Add cap vertices
    ...
    for (var _i4 = 0; _i4 < radialSegments; ++_i4) {
      ...
      positions[offset] = new miniprogram.Vector3(curPosX, -halfHeight, curPosZ); // Bottom normal

      normals[offset] = new miniprogram.Vector3(0, -1, 0); // Bottom texcoord

      uvs[offset++] = new miniprogram.Vector2(curPosX * diameterBottomReciprocal + 0.5, 0.5 - curPosZ * diameterBottomReciprocal);
      var curPosTop = positions[_i4 + positionStride];
      curPosX = curPosTop.x;
      curPosZ = curPosTop.z; // Top position

      positions[offset] = new miniprogram.Vector3(curPosX, halfHeight, curPosZ); // Top normal

      normals[offset] = new miniprogram.Vector3(0, 1, 0); // Top texcoord

      uvs[offset++] = new miniprogram.Vector2(curPosX * diameterTopReciprocal + 0.5, curPosZ * diameterTopReciprocal + 0.5);
    } // Add cap indices
  ...
  PrimitiveMesh.createCone = function createCone(engine, radius, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    uvs[torsoVertexCount] = new miniprogram.Vector2(0.5, 0.5); // Add bottom cap vertices
  ...
  PrimitiveMesh._generateIndices = function _generateIndices(engine, vertexCount, indexCount) {
    ...
    if (vertexCount > 65535) {
      if (engine._hardwareRenderer.canIUse(exports.GLCapabilityType.elementIndexUint)) {
...
var Basic2DBatcher = /*#__PURE__*/function () {
  ...
  _proto._getSubMeshFromPool = function _getSubMeshFromPool(start, count) {
    ...
    subMesh.start = start;
    subMesh.count = count;
    subMesh.topology = exports.MeshTopology.Triangles;
    return subMesh;
  }
  /**
   * @internal
...
var SpriteMaskBatcher = /*#__PURE__*/function (_Basic2DBatcher) {
  ...
  _proto.createVertexElements = function createVertexElements(vertexElements) {
    ...
    vertexElements[1] = new VertexElement("TEXCOORD_0", 12, exports.VertexElementFormat.Vector2, 0);
    return 20;
  };
  ...
  _proto.drawBatches = function drawBatches(engine) {
    ...
    for (var i = 0, len = subMeshes.length; i < len; i++) {
      ...
      var op = spriteMaskElement.isAdd ? exports.StencilOperation.IncrementSaturate : exports.StencilOperation.DecrementSaturate;
...
var SpriteMaskManager = /*#__PURE__*/function () {
  ...
  _proto.preRender = function preRender(camera, renderer) {
    if (renderer.maskInteraction === exports.SpriteMaskInteraction.None) {
      return;
    }
...
var Background = /*#__PURE__*/function () {
  ...
  function Background(_engine) {
    ...
    this.mode = exports.BackgroundMode.SolidColor;
    this.solidColor = new miniprogram.Color(0.25, 0.25, 0.25, 1.0);
    this.sky = new Sky();
...
var AmbientLight = /*#__PURE__*/function () {
  function AmbientLight(scene) {
    ...
    this._diffuseSolidColor = new miniprogram.Color(0.212, 0.227, 0.259);
  ...
  _createClass(AmbientLight, [{
    ...
    set: function set(value) {
      ...
      if (value === exports.DiffuseMode.SphericalHarmonics) {
...
var Light = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Light, [{
    ...
    get: function get() {
      ...
      miniprogram.Matrix.invert(this.entity.transform.worldMatrix, this._viewMat);
    ...
    get: function get() {
      if (!this._inverseViewMat) this._inverseViewMat = new miniprogram.Matrix();
      miniprogram.Matrix.invert(this.viewMatrix, this._inverseViewMat);
...
var DirectLight = /*#__PURE__*/function (_Light) {
  ...
  function DirectLight() {
    ...
    _this.color = new miniprogram.Color(1, 1, 1, 1);
    _this.intensity = 1;
    _this._forward = new miniprogram.Vector3();
    _this._lightColor = new miniprogram.Color(1, 1, 1, 1);
...
var Collider = /*#__PURE__*/function (_Component) {
  ...
  _proto._updateHitResult = function _updateHitResult(ray, distance, outHit, origin, isWorldRay) {
    ...
    if (!isWorldRay) {
      miniprogram.Vector3.transformCoordinate(outHit.point, this.entity.transform.worldMatrix, outHit.point);
    }

    outHit.distance = miniprogram.Vector3.distance(origin, outHit.point);
...
Collider._ray = new miniprogram.Ray();
...
ABoxCollider._tempBox = new miniprogram.BoundingBox();
...
var PlaneCollider = /*#__PURE__*/function (_Collider) {
  ...
  _proto._raycast = function _raycast(ray, hit) {
    ...
    boundingPlane.distance = -miniprogram.Vector3.dot(this.planePoint, boundingPlane.normal);
...
PlaneCollider._tempPlane = new miniprogram.Plane();
...
var ASphereCollider = /*#__PURE__*/function (_Collider) {
  ...
  _proto._raycast = function _raycast(ray, hit) {
    ...
    miniprogram.Vector3.transformCoordinate(this.center, transform.worldMatrix, boundingSphere.center);
...
ASphereCollider._tempSphere = new miniprogram.BoundingSphere();
...
var HitResult = function HitResult() {
  this.collider = null;
  this.distance = 0;
  this.point = new miniprogram.Vector3();
  this.normal = new miniprogram.Vector3();
};
...
var PhysicsManager = /*#__PURE__*/function () {
  ...
  _proto.raycast = function raycast(ray, distanceOrResult, layerMaskOrResult, outHitResult) {
    ...
    var layerMask = exports.Layer.Everything;
...
var Engine = /*#__PURE__*/function (_EventDispatcher) {
  ...
  function Engine(canvas, hardwareRenderer) {
    ...
    var whiteTexture2D = new Texture2D(_assertThisInitialized(_this), 1, 1, exports.TextureFormat.R8G8B8A8, false);
    whiteTexture2D.setPixelBuffer(whitePixel);
    whiteTexture2D.isGCIgnored = true;
    var whiteTextureCube = new TextureCubeMap(_assertThisInitialized(_this), 1, exports.TextureFormat.R8G8B8A8, false);
    whiteTextureCube.setPixelBuffer(exports.TextureCubeFace.PositiveX, whitePixel);
    whiteTextureCube.setPixelBuffer(exports.TextureCubeFace.NegativeX, whitePixel);
    whiteTextureCube.setPixelBuffer(exports.TextureCubeFace.PositiveY, whitePixel);
    whiteTextureCube.setPixelBuffer(exports.TextureCubeFace.NegativeY, whitePixel);
    whiteTextureCube.setPixelBuffer(exports.TextureCubeFace.PositiveZ, whitePixel);
    whiteTextureCube.setPixelBuffer(exports.TextureCubeFace.NegativeZ, whitePixel);
    ...
    _this._backgroundTextureMaterial.renderState.depthState.compareFunction = exports.CompareFunction.LessEqual;
  ...
  _proto._createSpriteMaterial = function _createSpriteMaterial() {
    ...
    target.enabled = true;
    target.sourceColorBlendFactor = exports.BlendFactor.SourceAlpha;
    target.destinationColorBlendFactor = exports.BlendFactor.OneMinusSourceAlpha;
    target.sourceAlphaBlendFactor = exports.BlendFactor.One;
    target.destinationAlphaBlendFactor = exports.BlendFactor.OneMinusSourceAlpha;
    target.colorBlendOperation = target.alphaBlendOperation = exports.BlendOperation.Add;
    renderState.depthState.writeEnabled = false;
    renderState.rasterState.cullMode = exports.CullMode.Off;
  ...
  _proto._createSpriteMaskMaterial = function _createSpriteMaskMaterial() {
    ...
    var renderState = material.renderState;
    renderState.blendState.targetBlendState.colorWriteMask = exports.ColorWriteMask.None;
    renderState.rasterState.cullMode = exports.CullMode.Off;
...
var SystemInfo = /*#__PURE__*/function () {
  ...
  SystemInfo._isIos = function _isIos() {
    if (!miniprogramAdapter.window) {
      return false;
    }

    var ua = miniprogramAdapter.window.navigator.userAgent.toLocaleLowerCase();
...
var SpriteBatcher = /*#__PURE__*/function (_Basic2DBatcher) {
  ...
  _proto.createVertexElements = function createVertexElements(vertexElements) {
    vertexElements[0] = new VertexElement("POSITION", 0, exports.VertexElementFormat.Vector3, 0);
    vertexElements[1] = new VertexElement("TEXCOORD_0", 12, exports.VertexElementFormat.Vector2, 0);
    vertexElements[2] = new VertexElement("COLOR_0", 20, exports.VertexElementFormat.Vector4, 0);
    return 36;
  };
  ...
  _proto.checkBatchWithMask = function checkBatchWithMask(left, right) {
    ...
    if (leftMaskInteraction === exports.SpriteMaskInteraction.None) {
      return true;
    }
...
var BasicRenderPipeline = /*#__PURE__*/function () {
  ...
  _proto.pushPrimitive = function pushPrimitive(element) {
    ...
    if (renderQueueType > exports.RenderQueueType.Transparent + exports.RenderQueueType.AlphaTest >> 1) {
      this._transparentQueue.pushPrimitive(element);
    } else if (renderQueueType > exports.RenderQueueType.AlphaTest + exports.RenderQueueType.Opaque >> 1) {
  ...
  _proto._drawSky = function _drawSky(engine, camera, sky) {
    ...
    e[12] = e[13] = e[14] = 0;
    miniprogram.Matrix.multiply(projectionMatrix, _matrix, _matrix);
...
var Camera = (_dec = dependencies(Transform), _dec(_class$2 = (_class2$2 = (_temp$2 = _class3 = /*#__PURE__*/function (_Component) {
  ...
  function Camera(entity) {
    ...
    _this.clearFlags = exports.CameraClearFlags.DepthColor;
  ...
  _createClass(Camera, [{
    ...
    get: function get() {
      if (this._isInvViewProjDirty.flag) {
        ...
        miniprogram.Matrix.multiply(this._transform.worldMatrix, this.inverseProjectionMatrix, this._invViewProjMat);
      }
  ...
  writable: true,
  initializer: function initializer() {
    return new miniprogram.BoundingFrustum();
  }
...
var BaseMaterial = /*#__PURE__*/function (_Material) {
  ...
  function BaseMaterial(engine, shader) {
    ...
    _this.blendMode = exports.BlendMode.Normal;
  ...
  _createClass(BaseMaterial, [{
    ...
    set: function set(value) {
      ...
      if (value) {
        ...
        this.renderQueueType = this.shaderData.getFloat(BaseMaterial._alphaCutoffProp) ? exports.RenderQueueType.AlphaTest : exports.RenderQueueType.Opaque;
      }
    }
    /**
     * Alpha cutoff value.
    ...
    set: function set(value) {
      ...
      if (value > 0) {
        ...
        this.renderQueueType = this._isTransparent ? exports.RenderQueueType.Transparent : exports.RenderQueueType.AlphaTest;
      } else {
    ...
    set: function set(value) {
      ...
      switch (value) {
        case exports.RenderFace.Front:
          this.renderState.rasterState.cullMode = exports.CullMode.Back;
          break;

        case exports.RenderFace.Back:
          this.renderState.rasterState.cullMode = exports.CullMode.Front;
          break;

        case exports.RenderFace.Double:
    ...
    set: function set(value) {
      ...
      switch (value) {
        ...
        case exports.BlendMode.Additive:
          target.sourceColorBlendFactor = exports.BlendFactor.SourceAlpha;
          target.destinationColorBlendFactor = exports.BlendFactor.One;
          target.sourceAlphaBlendFactor = exports.BlendFactor.One;
          target.destinationAlphaBlendFactor = exports.BlendFactor.OneMinusSourceAlpha;
          target.colorBlendOperation = target.alphaBlendOperation = exports.BlendOperation.Add;
          break;
...
var BlinnPhongMaterial = /*#__PURE__*/function (_BaseMaterial) {
  ...
  function BlinnPhongMaterial(engine) {
    ...
    shaderData.setColor(BlinnPhongMaterial._diffuseColorProp, new miniprogram.Color(1, 1, 1, 1));
    ...
    shaderData.setVector4(BlinnPhongMaterial._tilingOffsetProp, new miniprogram.Vector4(1, 1, 0, 0));
...
var Sprite = /*#__PURE__*/function (_RefObject) {
  ...
  function Sprite(engine, texture, region, pivot, pixelsPerUnit, name) {
    ...
    _this = _RefObject.call(this, engine) || this;
    _this.name = void 0;
    _this._uv = [new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2()];
    _this._positions = [new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2(), new miniprogram.Vector2()];
    ...
    _this._atlasRegion = new miniprogram.Rect(0, 0, 1, 1);
    _this._atlasRegionOffset = new miniprogram.Vector4(0, 0, 0, 0);
  ...
  _createClass(Sprite, [{
    ...
    set: function set(value) {
      ...
      this._atlasRegion.setValue(x, y, miniprogram.MathUtil.clamp(value.width, 0, 1 - x), miniprogram.MathUtil.clamp(value.height, 0, 1 - y));
    ...
    set: function set(value) {
      ...
      this._atlasRegionOffset.setValue(x, y, miniprogram.MathUtil.clamp(value.z, 0, 1 - x), miniprogram.MathUtil.clamp(value.w, 0, 1 - y));
    ...
    set: function set(value) {
      this._pivot.setValue(miniprogram.MathUtil.clamp(value.x, 0, 1), miniprogram.MathUtil.clamp(value.y, 0, 1));
    ...
    set: function set(value) {
      ...
      var x = miniprogram.MathUtil.clamp(value.x, 0, 1);
      var y = miniprogram.MathUtil.clamp(value.y, 0, 1);
      region.setValue(x, y, miniprogram.MathUtil.clamp(value.width, 0, 1 - x), miniprogram.MathUtil.clamp(value.height, 0, 1 - y));
...
var SpriteRenderer = (_class$1 = (_temp$1 = _class2$1 = /*#__PURE__*/function (_Renderer) {
  ...
  _proto._render = function _render(camera) {
    ...
    if (this._isWorldMatrixDirty.flag || localDirty || this._isContainDirtyFlag(DirtyFlag.Sprite)) {
      ...
      for (var i = 0, n = _positions.length; i < n; i++) {
        ...
        miniprogram.Vector3.transformToVec3(localVertexPos, worldMatrix, _positions[i]);
      }
  ...
  _proto._updateBounds = function _updateBounds(worldBounds) {
    ...
    if (sprite) {
      if (this._customLocalBounds && this._customRootEntity) {
        ...
        miniprogram.BoundingBox.transform(this._customLocalBounds, worldMatrix, worldBounds);
      } else {
        var localBounds = sprite.bounds;
        var _worldMatrix = this._entity.transform.worldMatrix;
        miniprogram.BoundingBox.transform(localBounds, _worldMatrix, worldBounds);
      }
    } else {
      worldBounds.min.setValue(0, 0, 0);
      worldBounds.max.setValue(0, 0, 0);
  ...
  _proto._updateStencilState = function _updateStencilState() {
    ...
    if (maskInteraction === exports.SpriteMaskInteraction.None) {
      stencilState.enabled = false;
      stencilState.writeMask = 0xff;
      stencilState.referenceValue = 0;
      stencilState.compareFunctionFront = stencilState.compareFunctionBack = exports.CompareFunction.Always;
    } else {
      stencilState.enabled = true;
      stencilState.writeMask = 0x00;
      stencilState.referenceValue = 1;
      var compare = maskInteraction === exports.SpriteMaskInteraction.VisibleInsideMask ? exports.CompareFunction.LessEqual : exports.CompareFunction.Greater;
...
}(Renderer), _class2$1._textureProperty = Shader.getPropertyByName("u_spriteTexture"), _class2$1._tempVec3 = new miniprogram.Vector3(), _temp$1), (_descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_customLocalBounds", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
  ...
  writable: true,
  initializer: function initializer() {
    return new miniprogram.Color(1, 1, 1, 1);
  }
  ...
  writable: true,
  initializer: function initializer() {
    return exports.SpriteMaskInteraction.None;
  }
  ...
  writable: true,
  initializer: function initializer() {
    return exports.SpriteMaskLayer.Layer0;
  }
})), _class$1);
var DirtyFlag;
...
exports.AnimationProperty = void 0;
...
})(exports.AnimationProperty || (exports.AnimationProperty = {}));
...
var AnimationClip = /*#__PURE__*/function (_Motion) {
  ...
  _proto.addCurveBinding = function addCurveBinding(relativePath, type, propertyName, curve) {
    ...
    switch (propertyName) {
      case "position":
        property = exports.AnimationProperty.Position;
        break;

      case "rotation":
        property = exports.AnimationProperty.Rotation;
        break;

      case "scale":
        property = exports.AnimationProperty.Scale;
        break;

      case "blendShapeWeights":
        property = exports.AnimationProperty.BlendShapeWeights;
        break;
    }
  ...
  _proto._sampleAnimation = function _sampleAnimation(entity, time) {
    ...
    for (var i = length - 1; i >= 0; i--) {
      ...
      if (type === Transform) {
        switch (property) {
          case exports.AnimationProperty.Position:
            transform.position = val;
            break;

          case exports.AnimationProperty.Rotation:
            transform.rotationQuaternion = val;
            break;

          case exports.AnimationProperty.Scale:
            transform.scale = val;
            break;
        }
      }
...
AnimatorUtils._tempVector30 = new miniprogram.Vector3();
AnimatorUtils._tempVector31 = new miniprogram.Vector3();
...
})(exports.AnimatorLayerBlendingMode || (exports.AnimatorLayerBlendingMode = {}));
...
var AnimationCurveOwner = /*#__PURE__*/function () {
  function AnimationCurveOwner(target, type, property) {
    ...
    switch (property) {
      case exports.AnimationProperty.Position:
        this.defaultValue = new miniprogram.Vector3();
        this.fixedPoseValue = new miniprogram.Vector3();
        this.component = target.transform;
        break;

      case exports.AnimationProperty.Rotation:
        this.defaultValue = new miniprogram.Quaternion();
        this.fixedPoseValue = new miniprogram.Quaternion();
        this.component = target.transform;
        break;
      ...
      case exports.AnimationProperty.BlendShapeWeights:
...
var Animator = (_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
    ...
    if (additive) {
      ...
      switch (property) {
        case exports.AnimationProperty.Position:
          ...
          miniprogram.Vector3.subtract(value, baseValue, pos);
          return pos;

        case exports.AnimationProperty.Rotation:
          var rot = Animator._tempQuaternion;
          miniprogram.Quaternion.conjugate(baseValue, rot);
          miniprogram.Quaternion.multiply(rot, value, rot);
          return rot;

        case exports.AnimationProperty.Scale:
          var scale = Animator._tempVector3;
          miniprogram.Vector3.divide(value, baseValue, scale);
          return scale;
      }
    }
  ...
  _proto._updateLayer = function _updateLayer(layerIndex, firstLayer, deltaTime) {
    ...
    var layerAdditive = blendingMode === exports.AnimatorLayerBlendingMode.Additive;
  ...
  _proto._applyCrossClipValue = function _applyCrossClipValue(owner, srcValue, destValue, crossWeight, layerWeight, additive) {
    ...
    if (owner.type === Transform) {
      ...
      switch (owner.property) {
        case exports.AnimationProperty.Position:
          miniprogram.Vector3.lerp(srcValue, destValue, crossWeight, Animator._tempVector3);
          value = Animator._tempVector3;
          break;

        case exports.AnimationProperty.Rotation:
          miniprogram.Quaternion.slerp(srcValue, destValue, crossWeight, Animator._tempQuaternion);
      ...
      switch (owner.property) {
        case exports.AnimationProperty.Position:
          if (weight === 1.0) {
            ...
            miniprogram.Vector3.lerp(position, value, weight, position);
        ...
        case exports.AnimationProperty.Rotation:
          if (weight === 1.0) {
            ...
            miniprogram.Quaternion.slerp(rotationQuaternion, value, weight, rotationQuaternion);
        ...
        case exports.AnimationProperty.Scale:
          if (weight === 1.0) {
            ...
            var scale = transform.scale;
            miniprogram.Vector3.lerp(scale, value, weight, scale);
            transform.scale = scale;
          }
    ...
    if (owner.type === Transform) {
      ...
      switch (owner.property) {
        ...
        case exports.AnimationProperty.Scale:
          ...
          miniprogram.Vector3.multiply(scale, additiveValue, scale);
          transform.scale = scale;
          break;
      }
    }
  ...
  return Animator;
}(Component), _class2._tempVector3 = new miniprogram.Vector3(), _class2._tempQuaternion = new miniprogram.Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
function AnimatorControllerLayer(name) {
  this.name = name;
  this.weight = 1.0;
  this.blendingMode = exports.AnimatorLayerBlendingMode.Override;
...
var AnimatorState = /*#__PURE__*/function () {
  ...
  function AnimatorState(name) {
    this.name = name;
    this.speed = 1.0;
    this.wrapMode = exports.WrapMode.Loop;
...
var AnimationCurve = /*#__PURE__*/function () {
  ...
  _proto.addKey = function addKey(key) {
    ...
    if (!this._valueSize) {
      ...
      if (typeof key.value == "number") {
        this._valueSize = 1;
        this._valueType = exports.InterpolableValueType.Float;
        this._currentValue = 0;
      }

      if (key.value instanceof miniprogram.Vector2) {
        this._valueSize = 2;
        this._valueType = exports.InterpolableValueType.Vector2;
        this._currentValue = new miniprogram.Vector2();
      }

      if (key.value instanceof miniprogram.Vector3) {
        this._valueSize = 3;
        this._valueType = exports.InterpolableValueType.Vector3;
        this._currentValue = new miniprogram.Vector3();
      }

      if (key.value instanceof miniprogram.Vector4) {
        this._valueSize = 4;
        this._valueType = exports.InterpolableValueType.Vector4;
        this._currentValue = new miniprogram.Vector4();
      }

      if (key.value instanceof miniprogram.Quaternion) {
        this._valueSize = 4;
        this._valueType = exports.InterpolableValueType.Quaternion;
        this._currentValue = new miniprogram.Quaternion();
      }

      if (key.value instanceof Float32Array) {
        var size = key.value.length;
        this._valueSize = size;
        this._valueType = exports.InterpolableValueType.FloatArray;
  ...
  _proto.evaluate = function evaluate(time) {
    ...
    if (curIndex === -1) {
      ...
      switch (interpolation) {
        ...
        case exports.InterpolationType.Step:
          value = this._evaluateStep(nextIndex);
          break;

        case exports.InterpolationType.CubicSpine:
        case exports.InterpolationType.Hermite:
  ...
  _proto._evaluateLinear = function _evaluateLinear(frameIndex, nextFrameIndex, t) {
    ...
    switch (_valueType) {
      case exports.InterpolableValueType.Float:
        return keys[frameIndex].value * (1 - t) + keys[nextFrameIndex].value * t;

      case exports.InterpolableValueType.FloatArray:
      ...
      case exports.InterpolableValueType.Vector2:
        miniprogram.Vector2.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, this._currentValue);
        return this._currentValue;

      case exports.InterpolableValueType.Vector3:
        miniprogram.Vector3.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, this._currentValue);
        return this._currentValue;

      case exports.InterpolableValueType.Quaternion:
        miniprogram.Quaternion.slerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, this._currentValue);
        return this._currentValue;
    }
  };
...
var ParticleRenderer = /*#__PURE__*/function (_MeshRenderer) {
  ...
  function ParticleRenderer(props) {
    ...
    _this._positionRandomness = new miniprogram.Vector3();
    _this._positionArray = void 0;
    _this._velocity = new miniprogram.Vector3();
    _this._velocityRandomness = new miniprogram.Vector3();
    _this._acceleration = new miniprogram.Vector3();
    _this._accelerationRandomness = new miniprogram.Vector3();
  ...
  _proto._createMesh = function _createMesh() {
    ...
    if (vertexCount > ParticleRenderer._uint16VertexLimit) {
      if (this.engine._hardwareRenderer.canIUse(exports.GLCapabilityType.elementIndexUint)) {
        useUint32 = true;
    ...
    mesh.setIndexBufferBinding(indexBuffer, useUint32 ? exports.IndexFormat.UInt32 : exports.IndexFormat.UInt16);
    mesh.setVertexElements(vertexElements);
    mesh.addSubMesh(0, indices.length);
  ...
  _proto._updateSingleBuffer = function _updateSingleBuffer(i) {
    ...
    if (_updateDirtyFlag & DirtyFlagType.Color) {
      ...
      vertices[k0 + 9] = vertices[k1 + 9] = vertices[k2 + 9] = vertices[k3 + 9] = miniprogram.MathUtil.clamp(_color.r + getRandom() * _colorRandomness, 0, 1);
      vertices[k0 + 10] = vertices[k1 + 10] = vertices[k2 + 10] = vertices[k3 + 10] = miniprogram.MathUtil.clamp(_color.g + getRandom() * _colorRandomness, 0, 1);
      vertices[k0 + 11] = vertices[k1 + 11] = vertices[k2 + 11] = vertices[k3 + 11] = miniprogram.MathUtil.clamp(_color.b + getRandom() * _colorRandomness, 0, 1);
    }

    if (_updateDirtyFlag & DirtyFlagType.Alpha) {
      vertices[k0 + 12] = vertices[k1 + 12] = vertices[k2 + 12] = vertices[k3 + 12] = miniprogram.MathUtil.clamp(this._alpha + getRandom() * this._alphaRandomness, 0, 1);
    }
  ...
  _createClass(ParticleRenderer, [{
    ...
    set: function set(value) {
      if (value) {
        ...
        this.getMaterial().renderState.rasterState.cullMode = exports.CullMode.Off;
      }
...
var TrailRenderer = /*#__PURE__*/function (_MeshRenderer) {
  ...
  _proto._initGeometry = function _initGeometry() {
    ...
    mesh.setVertexBufferBinding(vertexBuffer, vertexStride);
    mesh.setVertexElements(vertexElements);
    mesh.addSubMesh(0, vertexCount, exports.MeshTopology.TriangleStrip);
    this._vertexBuffer = vertexBuffer;
...
var CollisionDetection = /*#__PURE__*/function (_Script) {
  ...
  function CollisionDetection(entity) {
    ...
    _this._box = new miniprogram.BoundingBox();
    return _this;
  }
  /**
  ...
  _proto._updateWorldBox = function _updateWorldBox(boxCollider, out) {
    ...
    miniprogram.BoundingBox.transform(source, mat, out);
  }
  /**
...
CollisionDetection._tempBox1 = new miniprogram.BoundingBox();
CollisionDetection._tempBox2 = new miniprogram.BoundingBox();
...
var Fog = /*#__PURE__*/function (_Component) {
  ...
  function Fog(entity) {
    ...
    _this = _Component.call(this, entity) || this;
    _this._color = new miniprogram.Color(1, 0, 0, 1);
...
var CubeProbe = /*#__PURE__*/function (_Probe) {
  ...
  _proto._setCamera = function _setCamera(faceIndex, camera) {
    ...
    miniprogram.Matrix.lookAt(this.position, cacheTarget, cacheUp, camera.viewMatrix);
...
var LightShadow = /*#__PURE__*/function () {
  ...
  function LightShadow(light, props) {
    ...
    this._mapSize = new miniprogram.Vector2(width, height);
...
var ShadowMapPass = /*#__PURE__*/function (_RenderPass) {
  ...
  function ShadowMapPass(name, priority, renderTarget, replaceMaterial, mask, light) {
    ...
    _this.light = void 0;
    _this.light = light;
    _this.clearColor = new miniprogram.Color(1, 1, 1, 1);
    return _this;
  }
  /**
   * @override
...
var ShadowPass = /*#__PURE__*/function (_RenderPass) {
  ...
  function ShadowPass() {
    ...
    _this.clearFlags = exports.CameraClearFlags.None;
    return _this;
  }
  /**
   * @override
