  ...
  _proto.callRender = function callRender(context) {
    ...
    for (var i = this._renderers.length - 1; i >= 0; --i) {
      ...
      if (camera.isOrthographic) {
        ...
        math.Vector3.subtract(center, position, center);
        element._distanceForSort = math.Vector3.dot(center, forward);
      } else {
        element._distanceForSort = math.Vector3.distanceSquared(center, position);
      }
...
ComponentsManager._tempVector0 = new math.Vector3();
ComponentsManager._tempVector1 = new math.Vector3();
...
var Transform = (_class$8 = (_temp$7 = _class2$7 = /*#__PURE__*/function (_Component) {
  ...
  return Transform;
}(Component), _class2$7._tempQuat0 = new math.Quaternion(), _class2$7._tempVec3 = new math.Vector3(), _class2$7._tempMat30 = new math.Matrix3x3(), _class2$7._tempMat31 = new math.Matrix3x3(), _class2$7._tempMat32 = new math.Matrix3x3(), _class2$7._tempMat40 = new math.Matrix(), _class2$7._tempMat41 = new math.Matrix(), _class2$7._tempMat42 = new math.Matrix(), _class2$7._tempMat43 = new math.Matrix(), _temp$7), (_descriptor$8 = _applyDecoratedDescriptor(_class$8.prototype, "_position", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var RenderContext = /*#__PURE__*/function () {
  ...
  _proto._setContext = function _setContext(camera) {
    this._camera = camera;
    math.Matrix.multiply(camera.projectionMatrix, camera.viewMatrix, this._viewProjectMatrix);
  };
...
var SpriteMask = (_class$6 = (_temp$5 = _class2$5 = /*#__PURE__*/function (_Renderer) {
  ...
  _proto._render = function _render(camera) {
    ...
    if (this._worldMatrixDirtyFlag.flag || localDirty || this._isSpriteDirty) {
      ...
      for (var i = 0, n = positions.length; i < n; i++) {
        ...
        math.Vector3.transformToVec3(localVertexPos, worldMatrix, positions[i]);
      }
  ...
  return SpriteMask;
}(Renderer), _class2$5._textureProperty = Shader.getPropertyByName("u_maskTexture"), _class2$5._alphaCutoffProperty = Shader.getPropertyByName("u_maskAlphaCutoff"), _class2$5._tempVec3 = new math.Vector3(), _temp$5), (_descriptor$6 = _applyDecoratedDescriptor(_class$6.prototype, "_positions", [deepClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    return [new math.Vector3(), new math.Vector3(), new math.Vector3(), new math.Vector3()];
  }
...
var PrimitiveMesh = /*#__PURE__*/function () {
  ...
  PrimitiveMesh.createSphere = function createSphere(engine, radius, segments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      positions[i] = new math.Vector3(posX, posY, posZ); // Normal

      normals[i] = new math.Vector3(posX, posY, posZ); // Texcoord

      uvs[i] = new math.Vector2(u, v);
    }
  ...
  PrimitiveMesh.createCuboid = function createCuboid(engine, width, height, depth, noLongerAccessible) {
    ...
    positions[0] = new math.Vector3(-halfWidth, halfHeight, -halfDepth);
    positions[1] = new math.Vector3(halfWidth, halfHeight, -halfDepth);
    positions[2] = new math.Vector3(halfWidth, halfHeight, halfDepth);
    positions[3] = new math.Vector3(-halfWidth, halfHeight, halfDepth);
    normals[0] = new math.Vector3(0, 1, 0);
    normals[1] = new math.Vector3(0, 1, 0);
    normals[2] = new math.Vector3(0, 1, 0);
    normals[3] = new math.Vector3(0, 1, 0);
    uvs[0] = new math.Vector2(0, 0);
    uvs[1] = new math.Vector2(1, 0);
    uvs[2] = new math.Vector2(1, 1);
    uvs[3] = new math.Vector2(0, 1); // Down

    positions[4] = new math.Vector3(-halfWidth, -halfHeight, -halfDepth);
    positions[5] = new math.Vector3(halfWidth, -halfHeight, -halfDepth);
    positions[6] = new math.Vector3(halfWidth, -halfHeight, halfDepth);
    positions[7] = new math.Vector3(-halfWidth, -halfHeight, halfDepth);
    normals[4] = new math.Vector3(0, -1, 0);
    normals[5] = new math.Vector3(0, -1, 0);
    normals[6] = new math.Vector3(0, -1, 0);
    normals[7] = new math.Vector3(0, -1, 0);
    uvs[4] = new math.Vector2(0, 1);
    uvs[5] = new math.Vector2(1, 1);
    uvs[6] = new math.Vector2(1, 0);
    uvs[7] = new math.Vector2(0, 0); // Left

    positions[8] = new math.Vector3(-halfWidth, halfHeight, -halfDepth);
    positions[9] = new math.Vector3(-halfWidth, halfHeight, halfDepth);
    positions[10] = new math.Vector3(-halfWidth, -halfHeight, halfDepth);
    positions[11] = new math.Vector3(-halfWidth, -halfHeight, -halfDepth);
    normals[8] = new math.Vector3(-1, 0, 0);
    normals[9] = new math.Vector3(-1, 0, 0);
    normals[10] = new math.Vector3(-1, 0, 0);
    normals[11] = new math.Vector3(-1, 0, 0);
    uvs[8] = new math.Vector2(0, 0);
    uvs[9] = new math.Vector2(1, 0);
    uvs[10] = new math.Vector2(1, 1);
    uvs[11] = new math.Vector2(0, 1); // Right

    positions[12] = new math.Vector3(halfWidth, halfHeight, -halfDepth);
    positions[13] = new math.Vector3(halfWidth, halfHeight, halfDepth);
    positions[14] = new math.Vector3(halfWidth, -halfHeight, halfDepth);
    positions[15] = new math.Vector3(halfWidth, -halfHeight, -halfDepth);
    normals[12] = new math.Vector3(1, 0, 0);
    normals[13] = new math.Vector3(1, 0, 0);
    normals[14] = new math.Vector3(1, 0, 0);
    normals[15] = new math.Vector3(1, 0, 0);
    uvs[12] = new math.Vector2(1, 0);
    uvs[13] = new math.Vector2(0, 0);
    uvs[14] = new math.Vector2(0, 1);
    uvs[15] = new math.Vector2(1, 1); // Front

    positions[16] = new math.Vector3(-halfWidth, halfHeight, halfDepth);
    positions[17] = new math.Vector3(halfWidth, halfHeight, halfDepth);
    positions[18] = new math.Vector3(halfWidth, -halfHeight, halfDepth);
    positions[19] = new math.Vector3(-halfWidth, -halfHeight, halfDepth);
    normals[16] = new math.Vector3(0, 0, 1);
    normals[17] = new math.Vector3(0, 0, 1);
    normals[18] = new math.Vector3(0, 0, 1);
    normals[19] = new math.Vector3(0, 0, 1);
    uvs[16] = new math.Vector2(0, 0);
    uvs[17] = new math.Vector2(1, 0);
    uvs[18] = new math.Vector2(1, 1);
    uvs[19] = new math.Vector2(0, 1); // Back

    positions[20] = new math.Vector3(-halfWidth, halfHeight, -halfDepth);
    positions[21] = new math.Vector3(halfWidth, halfHeight, -halfDepth);
    positions[22] = new math.Vector3(halfWidth, -halfHeight, -halfDepth);
    positions[23] = new math.Vector3(-halfWidth, -halfHeight, -halfDepth);
    normals[20] = new math.Vector3(0, 0, -1);
    normals[21] = new math.Vector3(0, 0, -1);
    normals[22] = new math.Vector3(0, 0, -1);
    normals[23] = new math.Vector3(0, 0, -1);
    uvs[20] = new math.Vector2(1, 0);
    uvs[21] = new math.Vector2(0, 0);
    uvs[22] = new math.Vector2(0, 1);
    uvs[23] = new math.Vector2(1, 1);
  ...
  PrimitiveMesh.createPlane = function createPlane(engine, width, height, horizontalSegments, verticalSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < vertexCount; ++i) {
      ...
      positions[i] = new math.Vector3(x * gridWidth - halfWidth, y * gridHeight - halfHeight, 0); // Normal

      normals[i] = new math.Vector3(0, 0, 1); // Texcoord

      uvs[i] = new math.Vector2(x * horizontalSegmentsReciprocal, 1 - y * verticalSegmentsReciprocal);
    }
  ...
  PrimitiveMesh.createCylinder = function createCylinder(engine, radiusTop, radiusBottom, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    for (var i = 0; i < torsoVertexCount; ++i) {
      ...
      normals[i] = new math.Vector3(sinTheta, slope, cosTheta); // Texcoord

      uvs[i] = new math.Vector2(u, 1 - v);
    }
    ...
    positions[torsoVertexCount] = new math.Vector3(0, -halfHeight, 0); // Bottom normal

    normals[torsoVertexCount] = new math.Vector3(0, -1, 0); // Bottom texcoord

    uvs[torsoVertexCount] = new math.Vector2(0.5, 0.5); // Top position

    positions[torsoVertexCount + 1] = new math.Vector3(0, halfHeight, 0); // Top normal

    normals[torsoVertexCount + 1] = new math.Vector3(0, 1, 0); // Top texcoord

    uvs[torsoVertexCount + 1] = new math.Vector2(0.5, 0.5); // Add cap vertices
    ...
    for (var _i4 = 0; _i4 < radialSegments; ++_i4) {
      ...
      positions[offset] = new math.Vector3(curPosX, -halfHeight, curPosZ); // Bottom normal

      normals[offset] = new math.Vector3(0, -1, 0); // Bottom texcoord

      uvs[offset++] = new math.Vector2(curPosX * diameterBottomReciprocal + 0.5, 0.5 - curPosZ * diameterBottomReciprocal);
      var curPosTop = positions[_i4 + positionStride];
      curPosX = curPosTop.x;
      curPosZ = curPosTop.z; // Top position

      positions[offset] = new math.Vector3(curPosX, halfHeight, curPosZ); // Top normal

      normals[offset] = new math.Vector3(0, 1, 0); // Top texcoord

      uvs[offset++] = new math.Vector2(curPosX * diameterTopReciprocal + 0.5, curPosZ * diameterTopReciprocal + 0.5);
    } // Add cap indices
  ...
  PrimitiveMesh.createTorus = function createTorus(engine, radius, tubeRadius, radialSegments, tubularSegments, arc, noLongerAccessible) {
    ...
    for (var i = 0; i <= radialSegments; i++) {
      for (var j = 0; j <= tubularSegments; j++) {
        ...
        var cosU = Math.cos(u);
        var sinU = Math.sin(u);
        var position = new math.Vector3((radius + tubeRadius * cosV) * cosU, (radius + tubeRadius * cosV) * sinU, tubeRadius * sinV);
        positions[offset] = position;
        var centerX = radius * cosU;
        var centerY = radius * sinU;
        normals[offset] = new math.Vector3(position.x - centerX, position.y - centerY, position.z).normalize();
        uvs[offset++] = new math.Vector2(j / tubularSegments, i / radialSegments);
      }
    }
  ...
  PrimitiveMesh.createCone = function createCone(engine, radius, height, radialSegments, heightSegments, noLongerAccessible) {
    ...
    uvs[torsoVertexCount] = new math.Vector2(0.5, 0.5); // Add bottom cap vertices
...
var Background = /*#__PURE__*/function () {
  ...
  function Background(_engine) {
    ...
    this.solidColor = new math.Color(0.25, 0.25, 0.25, 1.0);
    this.sky = new Sky();
...
var AmbientLight = /*#__PURE__*/function () {
  function AmbientLight(scene) {
    ...
    this._diffuseSolidColor = new math.Color(0.212, 0.227, 0.259);
...
var Collider = /*#__PURE__*/function (_Component) {
  ...
  _proto._updateHitResult = function _updateHitResult(ray, distance, outHit, origin, isWorldRay) {
    ...
    if (!isWorldRay) {
      math.Vector3.transformCoordinate(outHit.point, this.entity.transform.worldMatrix, outHit.point);
    }

    outHit.distance = math.Vector3.distance(origin, outHit.point);
  ...
  _proto._getLocalRay = function _getLocalRay(ray) {
    ...
    math.Vector3.transformCoordinate(ray.origin, worldToLocal, outRay.origin);
    math.Vector3.transformNormal(ray.direction, worldToLocal, outRay.direction);
...
ABoxCollider._tempBox = new math.BoundingBox();
...
var PlaneCollider = /*#__PURE__*/function (_Collider) {
  ...
  _proto._raycast = function _raycast(ray, hit) {
    ...
    boundingPlane.distance = -math.Vector3.dot(this.planePoint, boundingPlane.normal);
...
PlaneCollider._tempPlane = new math.Plane();
...
var ASphereCollider = /*#__PURE__*/function (_Collider) {
  ...
  _proto._raycast = function _raycast(ray, hit) {
    ...
    math.Vector3.transformCoordinate(this.center, transform.worldMatrix, boundingSphere.center);
...
ASphereCollider._tempSphere = new math.BoundingSphere();
...
var HitResult = function HitResult() {
  this.collider = null;
  this.distance = 0;
  this.point = new math.Vector3();
  this.normal = new math.Vector3();
};
...
var BasicRenderPipeline = /*#__PURE__*/function () {
  ...
  function BasicRenderPipeline(camera) {
    ...
    this._lastCanvasSize = new math.Vector2();
    this._camera = camera;
    var engine = camera.engine;
  ...
  _proto._drawSky = function _drawSky(engine, camera, sky) {
    ...
    e[12] = e[13] = e[14] = 0;
    math.Matrix.multiply(projectionMatrix, _matrix, _matrix);
...
MathTemp.tempVec2 = new math.Vector2();
  ...
  _createClass(Camera, [{
    ...
    get: function get() {
      if (this._isInvViewProjDirty.flag) {
        ...
        math.Matrix.multiply(this._transform.worldMatrix, this.inverseProjectionMatrix, this._invViewProjMat);
      }
...
var BlinnPhongMaterial = /*#__PURE__*/function (_BaseMaterial) {
  ...
  function BlinnPhongMaterial(engine) {
    ...
    shaderData.setColor(BlinnPhongMaterial._diffuseColorProp, new math.Color(1, 1, 1, 1));
    shaderData.setColor(BlinnPhongMaterial._specularColorProp, new math.Color(1, 1, 1, 1));
    shaderData.setColor(BlinnPhongMaterial._emissiveColorProp, new math.Color(0, 0, 0, 1));
    shaderData.setVector4(BlinnPhongMaterial._tilingOffsetProp, new math.Vector4(1, 1, 0, 0));
...
var PBRBaseMaterial = /*#__PURE__*/function (_BaseMaterial) {
  ...
  function PBRBaseMaterial(engine) {
    ...
    shaderData.enableMacro("O3_NEED_WORLDPOS");
    shaderData.enableMacro("O3_NEED_TILINGOFFSET");
    shaderData.setColor(PBRBaseMaterial._baseColorProp, new math.Color(1, 1, 1, 1));
    shaderData.setColor(PBRBaseMaterial._emissiveColorProp, new math.Color(0, 0, 0, 1));
    shaderData.setVector4(PBRBaseMaterial._tilingOffsetProp, new math.Vector4(1, 1, 0, 0));
...
var PBRSpecularMaterial = /*#__PURE__*/function (_PBRBaseMaterial) {
  ...
  function PBRSpecularMaterial(engine) {
    ...
    _this.shaderData.setColor(PBRSpecularMaterial._specularColorProp, new math.Color(1, 1, 1, 1));
...
var UnlitMaterial = /*#__PURE__*/function (_BaseMaterial) {
  ...
  function UnlitMaterial(engine) {
    ...
    shaderData.enableMacro("O3_NEED_TILINGOFFSET");
    shaderData.setColor(UnlitMaterial._baseColorProp, new math.Color(1, 1, 1, 1));
    shaderData.setVector4(UnlitMaterial._tilingOffsetProp, new math.Vector4(1, 1, 0, 0));
    return _this;
  }
  /**
   * @override
...
var Sprite = /*#__PURE__*/function (_RefObject) {
  ...
  function Sprite(engine, texture, region, pivot, pixelsPerUnit, name) {
    ...
    _this = _RefObject.call(this, engine) || this;
    _this.name = void 0;
    _this._uv = [new math.Vector2(), new math.Vector2(), new math.Vector2(), new math.Vector2()];
    _this._positions = [new math.Vector2(), new math.Vector2(), new math.Vector2(), new math.Vector2()];
    _this._bounds = new math.BoundingBox();
    _this._triangles = void 0;
    _this._assetID = void 0;
    _this._pixelsPerUnit = void 0;
    _this._texture = null;
    _this._atlasRotated = false;
    _this._region = new math.Rect(0, 0, 1, 1);
    _this._pivot = new math.Vector2(0.5, 0.5);
    _this._atlasRegion = new math.Rect(0, 0, 1, 1);
    _this._atlasRegionOffset = new math.Vector4(0, 0, 0, 0);
  ...
  _createClass(Sprite, [{
    ...
    set: function set(value) {
      var x = math.MathUtil.clamp(value.x, 0, 1);
      var y = math.MathUtil.clamp(value.y, 0, 1);

      this._atlasRegion.setValue(x, y, math.MathUtil.clamp(value.width, 0, 1 - x), math.MathUtil.clamp(value.height, 0, 1 - y));
    ...
    set: function set(value) {
      ...
      this._atlasRegionOffset.setValue(x, y, math.MathUtil.clamp(value.z, 0, 1 - x), math.MathUtil.clamp(value.w, 0, 1 - y));
    ...
    set: function set(value) {
      this._pivot.setValue(math.MathUtil.clamp(value.x, 0, 1), math.MathUtil.clamp(value.y, 0, 1));
    ...
    set: function set(value) {
      ...
      var x = math.MathUtil.clamp(value.x, 0, 1);
      var y = math.MathUtil.clamp(value.y, 0, 1);
      region.setValue(x, y, math.MathUtil.clamp(value.width, 0, 1 - x), math.MathUtil.clamp(value.height, 0, 1 - y));
  ...
  _proto._render = function _render(camera) {
    ...
    if (this._isWorldMatrixDirty.flag || localDirty || this._isContainDirtyFlag(DirtyFlag.Sprite)) {
      ...
      for (var i = 0, n = _positions.length; i < n; i++) {
        ...
        math.Vector3.transformToVec3(localVertexPos, worldMatrix, _positions[i]);
      }
  ...
  _proto._updateBounds = function _updateBounds(worldBounds) {
    ...
    if (sprite) {
      if (this._customLocalBounds && this._customRootEntity) {
        ...
        math.BoundingBox.transform(this._customLocalBounds, worldMatrix, worldBounds);
      } else {
        var localBounds = sprite.bounds;
        var _worldMatrix = this._entity.transform.worldMatrix;
        math.BoundingBox.transform(localBounds, _worldMatrix, worldBounds);
      }
    } else {
      worldBounds.min.setValue(0, 0, 0);
      worldBounds.max.setValue(0, 0, 0);
...
}(Renderer), _class2$1._textureProperty = Shader.getPropertyByName("u_spriteTexture"), _class2$1._tempVec3 = new math.Vector3(), _temp$1), (_descriptor$1 = _applyDecoratedDescriptor(_class$1.prototype, "_customLocalBounds", [ignoreClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
AnimatorUtils._tempVector30 = new math.Vector3();
AnimatorUtils._tempVector31 = new math.Vector3();
...
var AnimationCurveOwner = /*#__PURE__*/function () {
  function AnimationCurveOwner(target, type, property) {
    ...
    switch (property) {
      case exports.AnimationProperty.Position:
        this.defaultValue = new math.Vector3();
        this.fixedPoseValue = new math.Vector3();
        this.component = target.transform;
        break;

      case exports.AnimationProperty.Rotation:
        this.defaultValue = new math.Quaternion();
        this.fixedPoseValue = new math.Quaternion();
        this.component = target.transform;
        break;
...
var Animator = (_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
    ...
    if (additive) {
      ...
      switch (property) {
        case exports.AnimationProperty.Position:
          ...
          math.Vector3.subtract(value, baseValue, pos);
          return pos;

        case exports.AnimationProperty.Rotation:
          var rot = Animator._tempQuaternion;
          math.Quaternion.conjugate(baseValue, rot);
          math.Quaternion.multiply(rot, value, rot);
          return rot;

        case exports.AnimationProperty.Scale:
          var scale = Animator._tempVector3;
          math.Vector3.divide(value, baseValue, scale);
          return scale;
      }
    }
  ...
  _proto._applyCrossClipValue = function _applyCrossClipValue(owner, srcValue, destValue, crossWeight, layerWeight, additive) {
    ...
    if (owner.type === Transform) {
      ...
      switch (owner.property) {
        case exports.AnimationProperty.Position:
          math.Vector3.lerp(srcValue, destValue, crossWeight, Animator._tempVector3);
          value = Animator._tempVector3;
          break;

        case exports.AnimationProperty.Rotation:
          math.Quaternion.slerp(srcValue, destValue, crossWeight, Animator._tempQuaternion);
      ...
      switch (owner.property) {
        case exports.AnimationProperty.Position:
          if (weight === 1.0) {
            ...
            math.Vector3.lerp(position, value, weight, position);
        ...
        case exports.AnimationProperty.Rotation:
          if (weight === 1.0) {
            ...
            math.Quaternion.slerp(rotationQuaternion, value, weight, rotationQuaternion);
        ...
        case exports.AnimationProperty.Scale:
          if (weight === 1.0) {
            ...
            var scale = transform.scale;
            math.Vector3.lerp(scale, value, weight, scale);
            transform.scale = scale;
          }
    ...
    if (owner.type === Transform) {
      ...
      switch (owner.property) {
        ...
        case exports.AnimationProperty.Scale:
          ...
          math.Vector3.multiply(scale, additiveValue, scale);
          transform.scale = scale;
          break;
      }
    }
  ...
  return Animator;
}(Component), _class2._tempVector3 = new math.Vector3(), _class2._tempQuaternion = new math.Quaternion(), _class2._animatorInfo = new AnimatorStateInfo(), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "_speed", [assignmentClone], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var AnimationCurve = /*#__PURE__*/function () {
  ...
  _proto.addKey = function addKey(key) {
    ...
    if (!this._valueSize) {
      ...
      if (key.value instanceof math.Vector2) {
        this._valueSize = 2;
        this._valueType = exports.InterpolableValueType.Vector2;
        this._currentValue = new math.Vector2();
      }

      if (key.value instanceof math.Vector3) {
        this._valueSize = 3;
        this._valueType = exports.InterpolableValueType.Vector3;
        this._currentValue = new math.Vector3();
      }

      if (key.value instanceof math.Vector4) {
        this._valueSize = 4;
        this._valueType = exports.InterpolableValueType.Vector4;
        this._currentValue = new math.Vector4();
      }

      if (key.value instanceof math.Quaternion) {
        this._valueSize = 4;
        this._valueType = exports.InterpolableValueType.Quaternion;
        this._currentValue = new math.Quaternion();
      }
  ...
  _proto._evaluateLinear = function _evaluateLinear(frameIndex, nextFrameIndex, t) {
    ...
    switch (_valueType) {
      ...
      case exports.InterpolableValueType.Vector2:
        math.Vector2.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, this._currentValue);
        return this._currentValue;

      case exports.InterpolableValueType.Vector3:
        math.Vector3.lerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, this._currentValue);
        return this._currentValue;

      case exports.InterpolableValueType.Quaternion:
        math.Quaternion.slerp(keys[frameIndex].value, keys[nextFrameIndex].value, t, this._currentValue);
        return this._currentValue;
    }
  };
...
var ShadowMapPass = /*#__PURE__*/function (_RenderPass) {
  ...
  function ShadowMapPass(name, priority, renderTarget, replaceMaterial, mask, light) {
    ...
    _this.light = void 0;
    _this.light = light;
    _this.clearColor = new math.Color(1, 1, 1, 1);
    return _this;
  }
  /**
   * @override
