...
export declare class Texture2DArray extends Texture {
     ...
     * @param depth - Number of elements in the array
     * @param format - Texture format. default  `TextureFormat.R8G8B8A8`
     * @param mipmap - Whether to use multi-level texture
     */
    constructor(engine: Engine, width: number, height: number, depth: number, format?: TextureFormat, mipmap?: boolean);
    /**
     ...
     */
    setPixelBuffer(index: number, colorBuffer: ArrayBufferView, mipLevel?: number, x?: number, y?: number, width?: number, height?: number): void;
    /**
