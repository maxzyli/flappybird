...
engine.resourceManager
  .load([
    ...
    {
      // Pipe.
      url: "resource/pipe.png",
      type: AssetType.Texture2D
    },
    {
      // Ground.
      url:
        "resource/A_Sj7OS4YJHDIAAAAAAAAAAAAAARQnAQ.png",
      type: AssetType.Texture2D
    },
    {
      // Bird.
      url: "resource/bird.png",
      type: AssetType.Texture2D
    },
    {
      // Restart.
      url:
        "resource/restart.png",
      type: AssetType.Texture2D
    },
    {
      // Number.
      url:
        "resource/527-number.png",
      type: AssetType.Texture2D
    }
  ])
